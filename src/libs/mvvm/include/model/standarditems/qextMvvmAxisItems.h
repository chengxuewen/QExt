...
public:
    ...
    QEXTMvvmFixedBinAxisItem(const std::string& QEXTMvvmModelType = Constants::FixedBinAxisItemType);
...
{
public:
    QEXTMvvmPointwiseAxisItem(const std::string& QEXTMvvmModelType = Constants::PointwiseAxisItemType);
