...
{
public:
    explicit DefaultViewModelController(QEXTMvvmSessionModel* session_model, ViewModelBase* view_model);
};
...
{
public:
    explicit TopItemsViewModelController(QEXTMvvmSessionModel* session_model, ViewModelBase* view_model);
};
...
{
public:
    explicit PropertyViewModelController(QEXTMvvmSessionModel* session_model, ViewModelBase* view_model);
...
{
public:
    PropertyTableViewModelController(QEXTMvvmSessionModel* session_model, ViewModelBase* view_model,
...
{
public:
    explicit PropertyFlatViewModelController(QEXTMvvmSessionModel* session_model,
