...
QEXT_MVVM_API std::unique_ptr<ViewModel> CreateDefaultViewModel(SessionModel* model);

//! Creates view model to represent SessionModel for Qt views.
//! The model has two columns, shows only property items and simplified group items.
QEXT_MVVM_API std::unique_ptr<ViewModel> CreatePropertyViewModel(SessionModel* model);
...
QEXT_MVVM_API std::unique_ptr<ViewModel> CreatePropertyTableViewModel(SessionModel* model);

//! Creates view model to represent SessionModel for Qt views.
//! Shows only top items.
QEXT_MVVM_API std::unique_ptr<ViewModel> CreateTopItemsViewModel(SessionModel* model);

//! Creates view model to represent SessionModel for Qt views.
//! The model has two columns, shows only property items and simplified group items.
//! Subproperties of group item moved one level up.
QEXT_MVVM_API std::unique_ptr<ViewModel> CreatePropertyFlatViewModel(SessionModel* model);
