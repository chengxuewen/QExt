...
std::vector<QEXTMvvmSessionItem*> SessionItemContainer::items() const
{
    return m_items;
}
...
bool SessionItemContainer::insertItem(QEXTMvvmSessionItem* item, int index)
{
...
QEXTMvvmSessionItem* SessionItemContainer::takeItem(int index)
{
    if (minimum_reached())
        return nullptr;
...
bool SessionItemContainer::canInsertItem(const QEXTMvvmSessionItem* item, int index) const
{
...
int SessionItemContainer::indexOfItem(const QEXTMvvmSessionItem* item) const
{
...
QEXTMvvmSessionItem* SessionItemContainer::itemAt(int index) const
{
...
bool SessionItemContainer::is_valid_item(const QEXTMvvmSessionItem* item) const
{
