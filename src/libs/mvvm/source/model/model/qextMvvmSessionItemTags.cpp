...
bool SessionItemTags::insertItem(QEXTMvvmSessionItem* item, const TagRow& tagrow)
{
...
QEXTMvvmSessionItem* SessionItemTags::takeItem(const TagRow& tagrow)
{
...
QEXTMvvmSessionItem* SessionItemTags::getItem(const TagRow& tagrow) const
{
...
std::vector<QEXTMvvmSessionItem*> SessionItemTags::getItems(const std::string& tag) const
{
    return container(tag)->items();
}

std::vector<QEXTMvvmSessionItem*> SessionItemTags::allitems() const
{
...
TagRow SessionItemTags::tagRowOfItem(const QEXTMvvmSessionItem* item) const
{
    for (auto cont : m_containers) {
