...
struct QEXTMvvmJsonItemTagsConverter::JsonItemTagsConverterImpl {
    std::unique_ptr<QEXTMvvmJsonItemContainerConverter> m_container_converter;
    ...
    {
        m_container_converter = std::make_unique<QEXTMvvmJsonItemContainerConverter>(std::move(callbacks));
        m_taginfo_converter = std::make_unique<QEXTMvvmJsonTagInfoConverter>();
    }
