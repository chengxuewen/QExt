...
#include <project/qextMvvmProject.h>
...
std::unique_ptr<QEXTMvvmProjectInterface> ProjectUtils::CreateUntitledProject(const QEXTMvvmProjectContext& context)
{
    return std::make_unique<QEXTMvvmProject>(context);
}
