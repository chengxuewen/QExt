...
void QEXTMvvmItemsTreeView::setViewModel(std::unique_ptr<QEXTMvvmViewModel> viewModel)
{
...
void QEXTMvvmItemsTreeView::setViewModelDelegate(std::unique_ptr<QEXTMvvmViewModelDelegate> delegate)
{
