...
void QEXTMvvmCustomPlotUtils::SetLogarithmicScale(QCPColorScale* axis, bool is_log_scale)
{
...
void QEXTMvvmCustomPlotUtils::SetLogarithmicScale(QCPAxis* axis, bool is_log_scale)
{
    if (is_log_scale) {
