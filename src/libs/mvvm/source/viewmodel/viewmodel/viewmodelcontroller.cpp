...
ViewModelController::ViewModelController(QEXTMvvmSessionModel* session_model, ViewModelBase* view_model)
...
QEXTMvvmSessionModel* ViewModelController::sessionModel() const
{
    return model();
}
...
void ViewModelController::onItemInserted(QEXTMvvmSessionItem* parent, QEXTMvvmTagRow tagrow)
{
    p_impl->insert_view(parent, tagrow);
}

void ViewModelController::onItemRemoved(QEXTMvvmSessionItem*, QEXTMvvmTagRow) {}

void ViewModelController::onAboutToRemoveItem(QEXTMvvmSessionItem* parent, QEXTMvvmTagRow tagrow)
{
