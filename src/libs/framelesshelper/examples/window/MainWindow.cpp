    ...
    , ui(new Ui::MainWindow())
{
    ...
    auto helper = new QEXTFramelessHelper(this);
    ...
    connect(ui->minimizeButton, &QPushButton::clicked,
            helper, &QEXTFramelessHelper::triggerMinimizeButtonAction);
    connect(ui->maximizeButton, &QPushButton::clicked,
            helper, &QEXTFramelessHelper::triggerMaximizeButtonAction);
    connect(ui->closeButton, &QPushButton::clicked,
            helper, &QEXTFramelessHelper::triggerCloseButtonAction);

    connect(helper, &QEXTFramelessHelper::maximizedChanged,
            this, &MainWindow::updateMaximizeButton);

    ui->maximizeButton->setIcon(QIcon(QStringLiteral(":/resource/maximize-button1.png")));
...
{
    if (maximized) {
        ui->maximizeButton->setIcon(QIcon(QStringLiteral(":/resource/maximize-button2.png")));
...
void MainWindow::paintEvent(QPaintEvent *event)
{
    ...
    QImage backgroundImage(QStringLiteral(":/resource/background.png"));
