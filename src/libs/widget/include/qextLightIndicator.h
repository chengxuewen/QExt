 ...
 *@History:
***************************************************************************************************/
#ifndef _QTKLIGHTINDICATOR_H
#define _QTKLIGHTINDICATOR_H
...
class QEXTLightIndicatorPrivate;
class QEXT_WIDGET_API QEXTLightIndicator : public QWidget, public QEXTObject
{
    Q_OBJECT
...
public:
    explicit QEXTLightIndicator(QWidget *parent = QEXT_DECL_NULLPTR);
    ~QEXTLightIndicator();
...
private:
    QEXT_DECL_PRIVATE(QEXTLightIndicator)
    QEXT_DISABLE_COPY_MOVE(QEXTLightIndicator)
};

#endif // _QTKLIGHTINDICATOR_H
