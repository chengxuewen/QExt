...
QEXTTumbler::QEXTTumbler(QWidget *parent) : QWidget(parent)
{
    currentIndex = 0;
    currentValue = "1";
...
void QEXTTumbler::drawBg(QPainter *painter)
{
    painter->save();
...
QStringList QEXTTumbler::getListValue() const
{
    return this->listValue;
}

int QEXTTumbler::getCurrentIndex() const
{
    return this->currentIndex;
}

QString QEXTTumbler::getCurrentValue() const
{
    return this->currentValue;
}

bool QEXTTumbler::getHorizontal() const
{
    return this->horizontal;
}

QColor QEXTTumbler::getForeground() const
{
    return this->foreground;
}

QColor QEXTTumbler::getBackground() const
{
    return this->background;
}

QColor QEXTTumbler::getLineColor() const
{
    return this->lineColor;
}

QColor QEXTTumbler::getTextColor() const
{
...
void QEXTTumbler::setListValue(const QStringList &listValue)
{
...
void QEXTTumbler::setCurrentIndex(int currentIndex)
{
    if (currentIndex >= 0) {
...
void QEXTTumbler::setCurrentValue(const QString &currentValue)
{
...
void QEXTTumbler::setForeground(const QColor &foreground)
{
...
void QEXTTumbler::setBackground(const QColor &background)
{
...
void QEXTTumbler::setLineColor(const QColor &lineColor)
{
...
void QEXTTumbler::setTextColor(const QColor &textColor)
{
