...
QEXTDateTimeTumbler::QEXTDateTimeTumbler(QWidget *parent) : QWidget(parent)
{
    this->initForm();
}
...
int QEXTDateTimeTumbler::getYear() const
{
    return tumblerYear->getCurrentValue().toInt();
}

int QEXTDateTimeTumbler::getMonth() const
{
    return tumblerMonth->getCurrentValue().left(2).toInt();
}

int QEXTDateTimeTumbler::getDay() const
{
    return tumblerDay->getCurrentValue().toInt();
}

int QEXTDateTimeTumbler::getHour() const
{
    return tumblerHour->getCurrentValue().toInt();
}

int QEXTDateTimeTumbler::getMin() const
{
    return tumblerMin->getCurrentValue().toInt();
}

int QEXTDateTimeTumbler::getSec() const
{
