...
void QEXTInput::setUpper(const bool &bIsUpper)
{
    ...
    //Change the icon
    ui->btnUpper->setIcon(QIcon(QString(":/QEXTWidget/image/btn_%1_%2.png").arg(bIsUpper ? "daxie" : "xiaoxie").arg(d_ptr->m_strIconType)));
}
...
void QEXTInput::setStyleType(const StyleTypes &eStyle)
{
    ...
    ui->labMore->setPixmap(QString(":/QEXTWidget/image/btn_%1_%2.png").arg("more").arg(d_ptr->m_strIconType));
    ui->btnDelete->setIcon(QIcon(QString(":/QEXTWidget/image/btn_%1_%2.png").arg("delete").arg(d_ptr->m_strIconType)));
    ui->btnDelete2->setIcon(QIcon(QString(":/QEXTWidget/image/btn_%1_%2.png").arg("delete").arg(d_ptr->m_strIconType)));
    ui->btnUpper->setIcon(QIcon(QString(":/QEXTWidget/image/btn_%1_%2.png").arg(d_ptr->m_bIsUpper ? "daxie" : "xiaoxie").arg(d_ptr->m_strIconType)));
}
