...
#include <qextLcdNumber_p.h>

#include <QDebug>
#include <QColor>
#include <QPainter>

QEXTLcdNumberPrivate::QEXTLcdNumberPrivate(QEXTLcdNumber *qq)
    : QEXTObjectPrivate(qq)
{
    ...
    m_symbol = QEXTLcdNumber::Symbol_None;

    m_dotVisiable = false;
    m_colonVisiable = false;
}

QEXTLcdNumberPrivate::~QEXTLcdNumberPrivate()
{

}


QEXTLcdNumber::QEXTLcdNumber(QWidget *parent)
    : QWidget(parent), QEXTObject(*(new QEXTLcdNumberPrivate(this)))
{

}

QEXTLcdNumber::~QEXTLcdNumber()
{

}

int QEXTLcdNumber::number() const
{
    QEXT_DECL_DC(QEXTLcdNumber);
    return d->m_number;
}

int QEXTLcdNumber::space() const
{
    QEXT_DECL_DC(QEXTLcdNumber);
    return d->m_space;
}

QColor QEXTLcdNumber::backgroundStartColor() const
{
    QEXT_DECL_DC(QEXTLcdNumber);
    return d->m_backgroundStartColor;
}

QColor QEXTLcdNumber::backgroundEndColor() const
{
    QEXT_DECL_DC(QEXTLcdNumber);
    return d->m_backgroundEndColor;
}

QColor QEXTLcdNumber::numberStartColor() const
{
    QEXT_DECL_DC(QEXTLcdNumber);
    return d->m_numberStartColor;
}

QColor QEXTLcdNumber::numberEndColor() const
{
    QEXT_DECL_DC(QEXTLcdNumber);
    return d->m_numberEndColor;
}

QEXTLcdNumber::Symbol QEXTLcdNumber::symbolType() const
{
    QEXT_DECL_DC(QEXTLcdNumber);
    return d->m_symbol;
}

QSize QEXTLcdNumber::sizeHint() const
{
    return QSize(150, 200);
}

QSize QEXTLcdNumber::minimumSizeHint() const
{
    return QSize(20, 30);
}

void QEXTLcdNumber::setNumber(int number)
{
    QEXT_DECL_D(QEXTLcdNumber);
    if (number < 0 || number > 9)
    {
        qCritical() << "QEXTLcdNumber::setNumber():iNumber must be in range of 0~9!";
        return;
    }
...
void QEXTLcdNumber::setSpace(int space)
{
    QEXT_DECL_D(QEXTLcdNumber);
    if (space < 0) {
        qCritical() << "QEXTLcdNumber::setNumber():iNumber must br greate than zero!";
        return;
    }
    if (space != d->m_space) {
        d->m_space = space;
...
void QEXTLcdNumber::setBackgroundStartColor(const QColor &color)
{
    QEXT_DECL_D(QEXTLcdNumber);
...
void QEXTLcdNumber::setBackgroundEndColor(const QColor &color)
{
    QEXT_DECL_D(QEXTLcdNumber);
...
void QEXTLcdNumber::setNumberStartColor(const QColor &color)
{
    QEXT_DECL_D(QEXTLcdNumber);
...
void QEXTLcdNumber::setNumberEndColor(const QColor &color)
{
    QEXT_DECL_D(QEXTLcdNumber);
...
void QEXTLcdNumber::setSymbolType(const QEXTLcdNumber::Symbol &type)
{
    QEXT_DECL_D(QEXTLcdNumber);
    if (type != d->m_symbol) {
        d->m_symbol = type;
...
void QEXTLcdNumber::paintEvent(QPaintEvent *)
{
    QEXT_DECL_D(QEXTLcdNumber);
...
void QEXTLcdNumber::drawBackground(QPainter *painter)
{
    QEXT_DECL_D(QEXTLcdNumber);
    painter->save();
...
void QEXTLcdNumber::drawNumber(QPainter *painter)
{
    QEXT_DECL_D(QEXTLcdNumber);
    painter->save();
    painter->setPen(Qt::NoPen);
    ...
    case QEXTLcdNumber::Symbol_Line:
    {
