    ...
    ui(new Ui::MainWindow)
{
    ...
    ui->qtklightbutton_4->setText("警报灯");
    ui->qtklightbutton_4->setFontPixelSize(50);
    ui->qtklightbutton_5->setText("输出灯");
    ui->qtklightbutton_5->setFontPixelSize(50);
    ui->qtklightbutton_6->setText("灯");
    ui->qtklightbutton_7->setText("灯");
    ui->qtklightbutton_8->setText("灯");
    ui->qtklightbutton_9->setText("灯");
