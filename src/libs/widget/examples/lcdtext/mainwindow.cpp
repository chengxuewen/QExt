    ...
    ui(new Ui::MainWindow)
{
    ui->setupUi(this);
    ui->ledText1->setText("~!@#$%^&*()-+");
    ui->ledText1->setAnimationType(QEXTLedText::Animation_Static);
    ui->ledText1->setHighLightBorderEnable(true);

    ui->ledText2->setText("123456789");
    ui->ledText2->setAnimationType(QEXTLedText::Animation_LeftToRight);
    ui->ledText2->setTextColor(QColor(255, 107, 107));

    ui->ledText3->setText("ABCDEFG");
    ui->ledText3->setAnimationType(QEXTLedText::Animation_RightToLeft);
    ...
    ui->ledText4->setAnimationType(QEXTLedText::Animation_TopToBottom);
    ui->ledText4->setText(strText);

    ui->ledText5->setText("ABCDEFG");
    ui->ledText5->setAnimationType(QEXTLedText::Animation_TopToBottom);
    ...
    ui->ledText6->setAnimationType(QEXTLedText::Animation_BottomToTop);
