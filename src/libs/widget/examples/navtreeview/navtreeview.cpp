...
#include <ui_navtreeview.h>

#include <qextNavTreeWidget.h>

#include <QTimer>

NavTreeView::NavTreeView(QWidget *parent) : QWidget(parent), ui(new Ui::NavTreeView)
{
    ui->setupUi(this);
    this->initForm();
}
...
void NavTreeView::initForm()
{
    ...
    ui->navListView1->setExpendMode(QEXTNavTreeWidget::ExpendMode_SingleClick);
    ui->navListView2->setExpendMode(QEXTNavTreeWidget::ExpendMode_DoubleClick);
    ui->navListView3->setExpendMode(QEXTNavTreeWidget::ExpendMode_SingleClick);
    ui->navListView4->setExpendMode(QEXTNavTreeWidget::ExpendMode_DoubleClick);
}
