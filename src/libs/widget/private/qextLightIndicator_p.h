...
class QEXTLightIndicator;
class QEXT_WIDGET_API QEXTLightIndicatorPrivate : public QEXTObjectPrivate
{
public:
    explicit QEXTLightIndicatorPrivate(QEXTLightIndicator *qq);
    ~QEXTLightIndicatorPrivate();
    ...
    QEXTLightIndicator::Style m_style;    //风格类型
    QEXTLightIndicator::Shape m_shape;    //形状类型
...
private:
    QEXT_DECL_PUBLIC(QEXTLightIndicator)
    QEXT_DISABLE_COPY_MOVE(QEXTLightIndicatorPrivate)
};
