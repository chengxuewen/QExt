 ...
 * text-selected-off
 */
class QEXT_FONTAWESOME_API QEXTFontAwesome : public QObject
{
    Q_OBJECT
public:
    enum OptionType
    ...
    explicit QEXTFontAwesome(QObject *parent = QEXT_DECL_NULLPTR);
    ...
    Q_INVOKABLE QString textFromKey(const QString &key);
    Q_INVOKABLE QString textFromValue(const int &type);
