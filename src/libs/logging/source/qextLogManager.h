 ...
 * The Log4Qt runtime version is accessible over version(). The macros
     * \ref Log4Qt::QEXT_LOGGING_VERSION "QEXT_LOGGING_VERSION" and
     * \ref Log4Qt::QEXT_LOGGING_VERSION_STRING "QEXT_LOGGING_VERSION_STRING" provide the
     * compile time version.
     *
 * \note All the functions declared in this class are thread-safe.
 */
class QEXT_LOGGING_API LogManager
{
private:
    LogManager();
    ~LogManager();
    QEXT_DISABLE_COPY_MOVE(LogManager)
...
public:
     ...
     *
         ...
         * </tr><tr>
         * <td> QtDebugMsg </td>
         * <td> QExtLogLevel::DEBUG_INT </td>
         * </tr><tr bgcolor="#ffffff">
         * <td> QtWarningMsg </td>
         * <td> QExtLogLevel::WARN_INT </td>
         * </tr><tr>
         * <td> QtCriticalMsg </td>
         * <td> QExtLogLevel::ERROR_INT </td>
         * </tr><tr bgcolor="#ffffff">
         * <td> QtFatalMsg </td>
         * <td> QExtLogLevel::FATAL_INT </td>
         * </tr><tr>
         * <td> QtSystemMsg </td>
         * <td> QExtLogLevel::TRACE_INT </td>
         * </tr>
         * </table>
     *
     ...
     * with the level QExtLogLevel::ERROR_INT and QExtLogLevel::FATAL_INT are written
     ...
     * QExtLogLevel::DEBUG_INT is used. If no level string is found
     * QExtLogLevel::ERROR_INT is used.
     *
    ...
    *     configureLogLogger()
     ...
     *     \ref Log4Qt::QEXT_LOGGING_VERSION_STRING "QEXT_LOGGING_VERSION_STRING"
