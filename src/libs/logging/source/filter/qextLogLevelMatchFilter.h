 ...
 */
class QEXT_LOGGING_API LevelMatchFilter : public Filter
{
    Q_OBJECT
...
inline QExtLogLevel LevelMatchFilter::levelToMatch() const
{
...
inline void LevelMatchFilter::setLevelToMatch(QExtLogLevel level)
{
    mLevelToMatch = level;
}
