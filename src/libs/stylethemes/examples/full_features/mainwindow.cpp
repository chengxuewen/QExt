...
void MainWindowPrivate::updateThemeColorButtons()
{
    for (auto Button : ThemeColorButtons)
    {
        ...
        QString ButtonStylesheet = QString("background-color: %1; color: %2; border: none;")
...
void MainWindowPrivate::loadThemeAwareToolbarActionIcons()
{
    ...
    ui.actionWidget->setIcon(AdvancedStyleSheet->loadThemeAwareSvgIcon(":/full_features/images/folder_open.svg"));
    ...
    d(new MainWindowPrivate(this))
{
    ...
    connect(d->AdvancedStyleSheet, SIGNAL(stylesheetChanged()), this, SLOT(onStyleManagerStylesheetChanged()));
