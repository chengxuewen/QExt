 ...
 * text-selected-off
 */
class QEXT_ICONFONT_API QEXTIconFontAwesome : public QObject
{
    Q_OBJECT
public:
    enum OptionType
    ...
    explicit QEXTIconFontAwesome(QObject *parent = QEXT_DECL_NULLPTR);
...
QEXT_ICONFONT_API QEXTIconFontAwesome *qextGlobalFontAwesome();
