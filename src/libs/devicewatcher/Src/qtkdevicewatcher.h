...
#ifndef QEXTDeviceWatcher_H
#define QEXTDeviceWatcher_H
...
class QEXT_DEVICEWATCHER_EXPORT QEXTDeviceWatcher : public QObject
{
    Q_OBJECT
...
class QEXT_DEVICEWATCHER_EXPORT QEXTDeviceChangeEvent : public QEvent
{
public:
