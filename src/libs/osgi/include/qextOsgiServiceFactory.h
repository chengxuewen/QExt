...
#ifndef QTKSERVICEFACTORY_H
#define QTKSERVICEFACTORY_H
 ...
 * @brief The QTKServiceFactory class
 ...
 */
class QTK_PLUGINFRAMEWORK_EXPORT QTKServiceFactory
{
public:
    /**
     * @brief getService
     ...
     *
     * @param pPlugin The plugin using the service.
     ...
     * @see ctkPluginContext#getService
     */
    virtual QObject *getService(QSharedPointer<QTKPlugin> pPlugin, QTKServiceRegistration registration) = 0;
     ...
     *
     * @param pPlugin The ctkPlugin releasing the service.
     * @param registration The <code>ctkServiceRegistration</code> object for the
     *        service.
     ...
     */
    virtual void ungetService(QSharedPointer<QTKPlugin> pPlugin, QTKServiceRegistration registration,
                              QObject *pService) = 0;
};

QTK_PLUGINFRAMEWORK_END_NAMESPACE

Q_DECLARE_INTERFACE(QTK_PLUGINFRAMEWORK_NAMESPACE::QTKServiceFactory,
                    "org.qtk.services.ServiceFactory")

#endif // QTKSERVICEFACTORY_H
