...
#ifndef QTKLOGENTRY_H
#define QTKLOGENTRY_H
 ...
 * @see ctkLogListener
 */
class QTK_PLUGINFRAMEWORK_EXPORT QTKLogEntry
{
public:
    virtual ~QTKLogEntry() {}
     ...
     */
    virtual QTKServiceReference getServiceReference() const = 0;
     ...
     */
    virtual QTKRuntimeException *getException() const = 0;
 ...
 * @{
 */
typedef QSharedPointer<QTKLogEntry> QTKLogEntryPtr;
/** @}*/

QTK_PLUGINFRAMEWORK_END_NAMESPACE

Q_DECLARE_METATYPE(QTK_PLUGINFRAMEWORK_NAMESPACE::QTKLogEntryPtr)
