...
#ifndef QTKLOCATION_H
#define QTKLOCATION_H
 ...
 */
class QTK_PLUGINFRAMEWORK_EXPORT QTKLocation
{
public:
    virtual ~QTKLocation() {}
     ...
     */
    virtual QTKLocation *getParentLocation() const = 0;
     ...
     * @param bLock whether or not to lock this location
     ...
     * @param value the value of this location
     * @param bLock whether or not to lock this location
     * @param strLockFilePath the path to the lock file.  This path will be used to establish locks on this location.
     ...
     * @throws ctkRuntimeException if there was an unexpected problem while acquiring the lock
     */
    virtual bool set(const QUrl &value, bool lock, const QString &strLockFilePath) = 0;
    ...
    /**
     * @brief createLocation
     * Constructs a new location.
     * @param pParent the parent location.  A <code>null</code> value is allowed.
     * @param defaultValue the default value of the location. A <code>null</code> value is allowed.
     * @param bReadonly true if the location is read-only.
     * @return a new location.
     */
    virtual QTKLocation *createLocation(QTKLocation *pParent, const QUrl &defaultValue, bool bReadonly) = 0;
     ...
     */
    static const char *FILTER_USER;

    /**
     * @brief FILTER_QTK_HOME
     * Constant which defines the filter string for acquiring the service which
     * specifies the eclipse home location.
     */
    static const char *FILTER_QTK_HOME;
};

QTK_PLUGINFRAMEWORK_END_NAMESPACE

Q_DECLARE_INTERFACE(QTK_PLUGINFRAMEWORK_NAMESPACE::QTKLocation,
                    "org.qtk.service.datalocation.Location")
