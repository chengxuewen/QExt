...
**
****************************************************************************/
#ifndef QTKOBJECTCLASSDEFINITION_H
#define QTKOBJECTCLASSDEFINITION_H

#include "qtkattributedefinition.h"

QTK_PLUGINFRAMEWORK_BEGIN_NAMESPACE

/**
 * @ingroup QTKPluginFramework
 * @brief The QTKObjectClassDefinition class
 * Description for the data type information of an objectclass.
 */
class QTK_PLUGINFRAMEWORK_EXPORT QTKObjectClassDefinition
{
public:
    enum Filter {
        /**
    ...
    virtual ~QTKObjectClassDefinition() {}
     ...
     */
    virtual QList<QTKAttributeDefinitionPtr> getAttributeDefinitions(Filter filter) = 0;
     ...
     *
     * @param iSize Requested size of an icon, e.g. a 16x16 pixels icon then size =
     *        16
     * @return A QByteArray holding an icon or an empty QByteArray.
     */
    virtual QByteArray getIcon(int iSize) const = 0;
};

typedef QSharedPointer<QTKObjectClassDefinition> QTKObjectClassDefinitionPtr;

QTK_PLUGINFRAMEWORK_END_NAMESPACE

#endif // QTKOBJECTCLASSDEFINITION_H
