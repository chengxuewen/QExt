...
#ifndef QTKATTRIBUTEDEFINITION_H
#define QTKATTRIBUTEDEFINITION_H
 ...
 * @brief The QTKAttributeDefinition class
 ...
 */
class QTK_PLUGINFRAMEWORK_EXPORT QTKAttributeDefinition
{
public:
    typedef QVariant::Type Type;

    /**
     * @brief The Password struct
    ...
    virtual ~QTKAttributeDefinition() {}
     ...
     * </pre>
     *
     * @param strValue The value before turning it into the basic data type
     * @return a null QString, an empty QString, or another QString
     */
    virtual QString validate(const QString &strValue) const = 0;
...
typedef QSharedPointer<QTKAttributeDefinition> QTKAttributeDefinitionPtr;

QTK_PLUGINFRAMEWORK_END_NAMESPACE

Q_DECLARE_METATYPE(QTK_PLUGINFRAMEWORK_NAMESPACE::QTKAttributeDefinition::Password)

#endif // QTKATTRIBUTEDEFINITION_H
