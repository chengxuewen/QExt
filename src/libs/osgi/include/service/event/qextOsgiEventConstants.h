...
#ifndef QTKEVENTCONSTANTS_H
#define QTKEVENTCONSTANTS_H
...
struct QTK_PLUGINFRAMEWORK_EXPORT QTKEventConstants
{
     ...
     * @see ctkEvent
     */
    static const char *EVENT_TOPICS; // = "event.topics"
     ...
     */
    static const char *EVENT_FILTER; // = "event.filter"

    /**
     * @brief EVENT_DELIVERY
     ...
     */
    static const char *EVENT_DELIVERY; // = "event.delivery"

    /**
     * @brief DELIVERY_ASYNC_ORDERED
     ...
     * @see #EVENT_DELIVERY
     */
    static const char *DELIVERY_ASYNC_ORDERED; // = "async.ordered"

    /**
     * @brief DELIVERY_ASYNC_UNORDERED
     ...
     * @see #EVENT_DELIVERY
     */
    static const char *DELIVERY_ASYNC_UNORDERED; // = "async.unordered"
     ...
     */
    static const char *PLUGIN_ID; // = "plugin.id"
     ...
     */
    static const char *EXCEPTION_CLASS; // = "exception.class"

    /**
     * @brief EXCEPTION_MESSAGE
     ...
     * <code>QString</code>.
     */
    static const char *EXCEPTION_MESSAGE; // = "exception.message"
     ...
     * <code>long</code>.
     */
    static const char *SERVICE_ID; // = QTKPluginConstants::SERVICE_ID

    /**
     * @brief SERVICE_OBJECT_CLASS
     * A service's objectClass. The type of the value for this event property is
     * <code>QStringList</code>.
     */
    static const char *SERVICE_OBJECT_CLASS; // = "service.objectClass"
     ...
     */
    static const char *SERVICE_PID; // = QTKPluginConstants::SERVICE_PID
