...
#ifndef QTKEVENTHANDLER_H
#define QTKEVENTHANDLER_H
 ...
 * @brief The QTKEventHandler class
 * Listener for Events.
 *
 * <p>
 ...
 */
class QTKEventHandler
{
public:
    QTKEventHandler() {}
    virtual ~QTKEventHandler() {}
     ...
     */
    virtual void handleEvent(const QTKEvent &event) = 0;
};

QTK_PLUGINFRAMEWORK_END_NAMESPACE

Q_DECLARE_INTERFACE(QTK_PLUGINFRAMEWORK_NAMESPACE::QTKEventHandler, "org.qtk.service.event.EventHandler")

#endif // QTKEVENTHANDLER_H
