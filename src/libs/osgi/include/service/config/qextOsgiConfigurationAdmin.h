...
#ifndef QTKCONFIGURATIONADMIN_H
#define QTKCONFIGURATIONADMIN_H
 ...
 * @brief The QTKConfigurationAdmin class
 ...
 *
 */
class QTK_PLUGINFRAMEWORK_EXPORT QTKConfigurationAdmin
{
public:
    /**
     * @brief createFactoryConfiguration
     ...
     * calling plugin.
     *
     * @param strFactoryPid PID of factory (not <code>null</code>).
     ...
     */
    virtual QTKConfigurationPtr createFactoryConfiguration(const QString &strFactoryPid) = 0;
     ...
     *
     * @param strFactoryPid PID of factory (not <code>null</code>).
     * @param strLocation A plugin location string, or <code>null</code>.
     * @return a new <code>ctkConfiguration</code> object.
     * @throws ctkIOException if access to persistent storage fails.
     * @throws ctkSecurityException if caller does not have <code>ctkConfigurationPermission[*,CONFIGURE]</code>.
     */
    virtual QTKConfigurationPtr createFactoryConfiguration(const QString &strFactoryPid, const QString &strLocation) = 0;
     ...
     * time.
     *
     * @param strPid Persistent identifier.
     * @param strLocation The plugin location string, or <code>null</code>.
     ...
     */
    virtual QTKConfigurationPtr getConfiguration(const QString &strPid, const QString &strLocation) = 0;
     ...
     */
    virtual QTKConfigurationPtr getConfiguration(const QString &strPid) = 0;

    /**
     * @brief listConfigurations
     ...
     *
     * @param strFilter A filter string, or an empty string to retrieve all
     ...
     */
    virtual QList<QTKConfigurationPtr> listConfigurations(const QString &strFilter = QString()) = 0;

    /**
     * @brief SERVICE_FACTORYPID
     ...
     */
    static const char *SERVICE_FACTORYPID; // = "service.factoryPid";

    /**
     * @brief SERVICE_PLUGINLOCATION
     ...
     */
    static const char *SERVICE_PLUGINLOCATION; // = "service.pluginLocation";
};

QTK_PLUGINFRAMEWORK_END_NAMESPACE

Q_DECLARE_INTERFACE(QTK_PLUGINFRAMEWORK_NAMESPACE::QTKConfigurationAdmin,
                    "org.qtk.service.cm.ConfigurationAdmin")

#endif // QTKCONFIGURATIONADMIN_H
