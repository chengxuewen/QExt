...
#ifndef QTKCONFIGURATIONPLUGIN_H
#define QTKCONFIGURATIONPLUGIN_H
 ...
 * @brief The QTKConfigurationPlugin class
 ...
 *
 */
class QTK_PLUGINFRAMEWORK_EXPORT QTKConfigurationPlugin
{
public:
    virtual ~QTKConfigurationPlugin() {}
     ...
     * property.
     */
    static const char *CM_TARGET; // = "cm.target"
     ...
     * ones.
     */
    static const char *CM_RANKING; // = "service.cmRanking"

    /**
     * @brief modifyConfiguration
     ...
     */
    virtual void modifyConfiguration(const QTKServiceReference &reference, QTKDictionary &properties) = 0;
};

QTK_PLUGINFRAMEWORK_END_NAMESPACE

Q_DECLARE_INTERFACE(QTK_PLUGINFRAMEWORK_NAMESPACE::QTKConfigurationPlugin,
                    "org.qtk.service.cm.ConfigurationPlugin")

#endif // QTKCONFIGURATIONPLUGIN_H
