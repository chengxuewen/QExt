...
#ifndef QTKMANAGEDSERVICEFACTORY_H
#define QTKMANAGEDSERVICEFACTORY_H
 ...
 * @brief The QTKManagedServiceFactory class
 ...
 * \endcode
 */
class QTK_PLUGINFRAMEWORK_EXPORT QTKManagedServiceFactory
{
public:
    virtual ~QTKManagedServiceFactory() {}
     ...
     *
     * @param strPid The PID for this configuration.
     ...
     *         invalid.
     */
    virtual void updated(const QString &strPid, const QTKDictionary &properties) = 0;
     ...
     * The Configuration Admin service must call this method asynchronously.
     *
     * @param strPid the PID of the service to be removed
     */
    virtual void deleted(const QString &strPid) = 0;
};

QTK_PLUGINFRAMEWORK_END_NAMESPACE

Q_DECLARE_INTERFACE(QTK_PLUGINFRAMEWORK_NAMESPACE::QTKManagedServiceFactory,
                    "org.qtk.service.cm.ManagedServiceFactory")

#endif // QTKMANAGEDSERVICEFACTORY_H
