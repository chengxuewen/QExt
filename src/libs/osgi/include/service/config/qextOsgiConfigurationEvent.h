...
#ifndef QTKCONFIGURATIONEVENT_H
#define QTKCONFIGURATIONEVENT_H
...
class QTKConfigurationEventData;

/**
 * @ingroup QTKPluginFramework
 * @brief The QTKConfigurationEvent class
 ...
 */
class QTK_PLUGINFRAMEWORK_EXPORT QTKConfigurationEvent
{
public:
    enum Type {
        /**
     ...
     */
    QTKConfigurationEvent(const QTKConfigurationEvent& other);
    QTKConfigurationEvent(const QTKServiceReference& reference,
    ...
    QTKConfigurationEvent& operator=(const QTKConfigurationEvent& other);

private:
    QSharedDataPointer<QTKConfigurationEventData> d;
};

/**
 * @ingroup QTKPluginFramework
 */
QTK_PLUGINFRAMEWORK_EXPORT QDebug operator<<(QDebug dbg, QTKConfigurationEvent::Type type);
QTK_PLUGINFRAMEWORK_EXPORT QDebug operator<<(QDebug dbg, const QTKConfigurationEvent& event);
/** @}*/

QTK_PLUGINFRAMEWORK_END_NAMESPACE

#endif // QTKCONFIGURATIONEVENT_H
