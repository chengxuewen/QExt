...
#ifndef QTKMANAGEDSERVICE_H
#define QTKMANAGEDSERVICE_H
 ...
 * @brief The QTKManagedService class
 ...
 */
class QTKManagedService
{
public:
    virtual ~QTKManagedService() {}
     ...
     */
    virtual void updated(const QTKDictionary &properties) = 0;
};

QTK_PLUGINFRAMEWORK_END_NAMESPACE

Q_DECLARE_INTERFACE(QTK_PLUGINFRAMEWORK_NAMESPACE::QTKManagedService,
                    "org.qtk.service.cm.ManagedService")

#endif // QTKMANAGEDSERVICE_H
