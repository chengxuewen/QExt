...
#ifndef QTKCONFIGURATION_H
#define QTKCONFIGURATION_H
 ...
 * @brief The QTKConfiguration class
 ...
 */
class QTK_PLUGINFRAMEWORK_EXPORT QTKConfiguration
{
public:
    virtual ~QTKConfiguration();
     ...
     */
    virtual QTKDictionary getProperties() const = 0;
     ...
     * @throws ctkIllegalStateException if this configuration has been deleted
     */
    virtual void update(const QTKDictionary& properties) = 0;
     ...
     */
    bool operator==(const QTKConfiguration& other) const;
};
 ...
 * @{
 */
typedef QSharedPointer<QTKConfiguration> QTKConfigurationPtr;
 ...
 */
uint QTK_PLUGINFRAMEWORK_EXPORT qHash(QTKConfigurationPtr configuration);
bool QTK_PLUGINFRAMEWORK_EXPORT operator==(const QTKConfigurationPtr& c1, const QTKConfigurationPtr c2);
/** @}*/

QTK_PLUGINFRAMEWORK_END_NAMESPACE

#endif // QTKCONFIGURATION_H
