...
#ifndef QTKSERVICETRACKERCUSTOMIZER_H
#define QTKSERVICETRACKERCUSTOMIZER_H
...
class QTKServiceTrackerCustomizer
{
public:
    virtual ~QTKServiceTrackerCustomizer() {}
     ...
     *
     * @param serviceRef The reference to the service being added to the
     *        <code>ctkServiceTracker</code>.
     ...
     */
    virtual T addingService(const QTKServiceReference &serviceRef) = 0;
     ...
     *
     * @param serviceRef The reference to the service that has been modified.
     * @param service The service object for the specified referenced service.
     */
    virtual void modifiedService(const QTKServiceReference &serviceRef, T service) = 0;
     ...
     * <code>ctkServiceTracker</code>.
     *
     * @param serviceRef The reference to the service that has been removed.
     * @param service The service object for the specified referenced service.
     */
    virtual void removedService(const QTKServiceReference &serviceRef, T service) = 0;
};

QTK_PLUGINFRAMEWORK_END_NAMESPACE

#endif // QTKSERVICETRACKERCUSTOMIZER_H
