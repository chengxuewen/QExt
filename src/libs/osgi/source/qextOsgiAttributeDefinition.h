...
#ifndef _QEXTOSGIATTRIBUTEDEFINITION_H
#define _QEXTOSGIATTRIBUTEDEFINITION_H
 ...
 *
 * <p>
 * An <code>QExtOsgiAttributeDefinition</code> object defines a description of the data type
 * of a property/attribute.
 */
struct QEXT_OSGI_API QExtOsgiAttributeDefinition
{
   ...
   */
    ...
    virtual ~QExtOsgiAttributeDefinition() {}
   ...
   *
   * <p>
   * QVariant::UserType maps to QExtOsgiAttributeDefinition::Password only.
   *
   * @return The type for this attribute.
   */
 ...
 * \ingroup Metatype
 */
typedef QSharedPointer<QExtOsgiAttributeDefinition> QExtOsgiAttributeDefinitionPtr;

Q_DECLARE_METATYPE(QExtOsgiAttributeDefinition::Password)


#endif // _QEXTOSGIATTRIBUTEDEFINITION_H
