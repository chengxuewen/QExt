...
#ifndef _QEXTOSGIEVENTCONSTANTS_H
#define _QEXTOSGIEVENTCONSTANTS_H
 ...
 * \ingroup EventAdmin
 *
 * Defines standard names for <code>QExtOsgiEventHandler</code> and Qt event slot properties.
 *
 * \see QExtOsgiEventHandler
 * \see QExtOsgiEventAdmin::subscribeSlot()
 */
struct QEXT_OSGI_API QExtOsgiEventConstants
{

  /**
   * Registration property (named <code>event.topics</code>)
   * specifying the <code>QExtOsgiEvent</code> topics of interest to an Event Handler
   ...
   * specifying a filter to further select <code>QExtOsgiEvent</code> s of interest to
  ...
  /**
   * The QExtOsgiPlugin object of the plugin relevant to the event. The type of the
   * value for this event property is <code>QSharedPointer<QExtOsgiPlugin></code>.
   */
  static const QString PLUGIN; // = "plugin"

  /**
   * The version of the plugin relevant to the event. The type of the value
   * for this event property is {@link QExtOsgiVersion}.
   */
   ...
   * property depends on the event topic (for org/qext/PluginEvent/&0x42; the
   * the type will be QExtOsgiPluginEvent).
   */
  static const QString EVENT; // = "event"

  /**
   * An exception or error. The type of the value for this event property is
   * <code>QExtRuntimeException</code>.
   */
   ...
   * <code>long</code>.
   */
  static const QString SERVICE_ID; // = QExtOsgiPluginConstants::SERVICE_ID
   ...
   */
  static const QString SERVICE_PID; // = QExtOsgiPluginConstants::SERVICE_PID
...
#endif // _QEXTOSGIEVENTCONSTANTS_H
