...
#ifndef _QEXTOSGIMETATYPEPROVIDER_H
#define _QEXTOSGIMETATYPEPROVIDER_H

#include <qext/osgi/service/metatype/qextOsgiObjectClassDefinition.h>
 ...
 */
struct QEXT_OSGI_API QExtOsgiMetaTypeProvider
{

    /**
   * Service property to signal that this service has
   * {@link QExtOsgiObjectClassDefinition} objects for the given PIDs. The type of
   ...
   * @return A <code>QExtOsgiObjectClassDefinition</code> object.
   */
    virtual QExtOsgiObjectClassDefinitionPtr getObjectClassDefinition(
...
Q_DECLARE_INTERFACE(QExtOsgiMetaTypeProvider, "org.qext.service.metatype.MetaTypeProvider")

#endif // _QEXTOSGIMETATYPEPROVIDER_H
