...
#ifndef _QEXTOSGIOBJECTCLASSDEFINITION_H
#define _QEXTOSGIOBJECTCLASSDEFINITION_H

#include <qext/osgi/service/metatype/qextOsgiAttributeDefinition.h>
 ...
 */
struct QExtOsgiObjectClassDefinition
{
    ...
    virtual ~QExtOsgiObjectClassDefinition() {}
  ...
  *
  * <p>
  * <code>QExtOsgiObjectClassDefintion</code> objects share a global namespace in the
  ...
  */
    virtual QList<QExtOsgiAttributeDefinitionPtr> getAttributeDefinitions(Filter filter) = 0;
 ...
 * \ingroup Metatype
 */
typedef QSharedPointer<QExtOsgiObjectClassDefinition> QExtOsgiObjectClassDefinitionPtr;

#endif // _QEXTOSGIOBJECTCLASSDEFINITION_H
