...
#ifndef _QEXTOSGICONFIGURATIONPLUGIN_H
#define _QEXTOSGICONFIGURATIONPLUGIN_H
 ...
 *
 * <p>
 * A plugin registers a <code>QExtOsgiConfigurationPlugin</code> object in order to
 ...
 * every time before it calls the <code>QExtOsgiManagedService</code> or
 * <code>QExtOsgiManagedServiceFactory</code>
 ...
 * <code>QExtOsgiServicePermission[QExtOsgiConfigurationPlugin,REGISTER]</code>.
 ...
 *
 */
struct QEXT_OSGI_API QExtOsgiConfigurationPlugin
{
    virtual ~QExtOsgiConfigurationPlugin() {};
   ...
   */
    virtual void modifyConfiguration(const QExtOsgiServiceReference& reference,
                                     QExtOsgiDictionary& properties) = 0;
};

Q_DECLARE_INTERFACE(QExtOsgiConfigurationPlugin, "org.qext.service.cm.ConfigurationPlugin")

#endif // _QEXTOSGICONFIGURATIONPLUGIN_H
