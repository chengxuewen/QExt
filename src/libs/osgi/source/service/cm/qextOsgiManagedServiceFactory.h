...
#ifndef _QEXTOSGIMANAGEDSERVICEFACTORY_H
#define _QEXTOSGIMANAGEDSERVICEFACTORY_H
 ...
 * <code>QExtOsgiConfiguration</code> object that has a PID. When such a
 * <code>QExtOsgiConfiguration</code> is updated, the Configuration Admin service
 * calls the <code>QExtOsgiManagedServiceFactory</code> updated method with the new
 ...
 * corresponding <code>QExtOsgiConfiguration</code> object (but it should <b>not</b>
 ...
 * \code
 *
 *   class SerialPortFactory : public QObject, public QExtOsgiManagedServiceFactory
 *   {
 *
 ...
 *       properties.insert(QExtOsgiPluginConstants::SERVICE_PID,
 *         "com.acme.serialportfactory");
 *       registration = context->registerService<QExtOsgiManagedServiceFactory>(
 *         this, properties);
 *     }
 *
 *   public:
 *
 *     void updated(const QString& pid, const QExtOsgiDictionary& properties)
 *     {
 ...
 * \endcode
 */
struct QExtOsgiManagedServiceFactory
{
    virtual ~QExtOsgiManagedServiceFactory() {}
   ...
   * instance.
   *
   * If the PID of the <code>QExtOsgiConfiguration</code> object is new for the
   ...
   * {@link QExtOsgiConfigurationException} which describes the problem.
   *
   * <p>
   * The Configuration Admin service must call this method asynchronously.
   * This implies that implementors of the <code>QExtOsgiManagedServiceFactory</code>
   ...
   *        <code>QExtOsgiConfiguration#getPluginLocation</code> method.
   * @throws QExtOsgiConfigurationException when the configuration properties are
   *         invalid.
   */
    virtual void updated(const QString& pid, const QExtOsgiDictionary& properties) = 0;
...
Q_DECLARE_INTERFACE(QExtOsgiManagedServiceFactory, "org.qext.service.cm.ManagedServiceFactory")

#endif // _QEXTOSGIMANAGEDSERVICEFACTORY_H
