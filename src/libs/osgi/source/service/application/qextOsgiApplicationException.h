...
#ifndef _QEXTOSGIAPPLICATIONEXCEPTION_H
#define _QEXTOSGIAPPLICATIONEXCEPTION_H
 ...
 * management.
 *
 * <code>QExtOsgiApplicationException</code> object is created by the Application Admin
 * to denote an exception condition in the lifecycle of an application.
 * <code>QExtOsgiApplicationException</code>s should not be created by developers. <br/>
 * <code>QExtOsgiApplicationException</code>s are associated with an error code. This
 ...
 * </ul>
 */
class QEXT_OSGI_API QExtOsgiApplicationException : public QExtException
{
...
public:
   ...
   */
    QExtOsgiApplicationException(int errorCode);
   ...
   */
    QExtOsgiApplicationException(int errorCode, const QExtException& cause);
   ...
   */
    QExtOsgiApplicationException(int errorCode, const QString& message);
   ...
   * @param cause The cause of this exception.
   */
    QExtOsgiApplicationException(int errorCode, const QString& message, const QExtException& cause);

    ~QExtOsgiApplicationException() throw();

    const char* name() const throw();

    QExtOsgiApplicationException* clone() const;
...
#endif // _QEXTOSGIAPPLICATIONEXCEPTION_H
