...
#ifndef _QEXTOSGIPLUGINCONSTANTS_H
#define _QEXTOSGIPLUGINCONSTANTS_H
 ...
 */
struct QEXT_OSGI_API QExtOsgiPluginConstants
{
   ...
   * <code>QExtOsgiPluginContext::getProperty</code> method.
   */
    static const QString FRAMEWORK_VERSION; // = "org.qext.pluginfw.version"
   ...
   * <code>QExtOsgiPluginContext::getProperty</code> method.
   */
    static const QString FRAMEWORK_VENDOR; // = "org.qext.pluginfw.vendor"
   ...
   */
    static const QString FRAMEWORK_STORAGE; // = "org.qext.pluginfw.storage"
   ...
   */
    static const QString FRAMEWORK_STORAGE_CLEAN; // = "org.qext.pluginfw.storage.clean";
   ...
   */
    static const QString FRAMEWORK_PLUGIN_LOAD_HINTS; // = "org.qext.pluginfw.loadhints"
   ...
   */
    static const QString FRAMEWORK_PRELOAD_LIBRARIES; // = "org.qext.pluginfw.preloadlibs"
   ...
   * <p>
   * The attribute value may be retrieved from the <code>QHash</code>
   * object returned by the <code>QExtOsgiPlugin::getHeaders</code> method.
   */
   ...
   * returned by the <code>QExtOsgiPlugin::getHeaders</code> method.
   */
   ...
   *
   * <p>
   * The attribute value may be retrieved from the <code>QExtOsgiDictionary</code>
   * object returned by the <code>QExtOsgiPlugin::getHeaders()</code> method.
   */
   ...
   * QExtOsgiPlugin#START_ACTIVATION_POLICY option will be activating immediately when
   ...
   * @see QExtOsgiPlugin#start(int)
   * @see QExtOsgiPlugin#START_ACTIVATION_POLICY
   */
   ...
   * {@link QExtOsgiPlugin#START_ACTIVATION_POLICY START_ACTIVATION_POLICY} option
   * will wait in the QExtOsgiPlugin#STARTING state until the first
   ...
   */
    // ATTENTION!!! If the value is changed, change also QExtOsgiEventConstants::SERVICE_ID
   ...
   * <code>QExtOsgiDictionary</code> object passed to the
   * <code>QExtOsgiPluginContext#registerService</code> method. The value of this
   ...
   * the plugin's identifier (see QExtOsgiPlugin::getPluginId) and followed by
   * a dot (.). A plugin may use this as the prefix of the persistent
   * identifiers for the services it registers.
   */
    // ATTENTION!!! If the value is changed, change also QExtOsgiEventConstants::SERVICE_PID
   ...
   * order</i> of services, see QExtOsgiServiceReference::operator<(const QExtOsgiServiceReference&),
   * and the <i>default</i> service to be returned from a call to the
   * {@link QExtOsgiPluginContext::getServiceReference} method.
   *
   * <p>
   ...
   *
   * <p>
   * This property may be supplied in the properties <code>QExtOsgiDictionary</code> object
   * passed to the <code>QExtOsgiPluginContext::registerService()</code> method.
   */
...
#endif // _QEXTOSGIPLUGINCONSTANTS_H
