...
#ifndef _QEXTOSGISERVICEFACTORY_H
#define _QEXTOSGISERVICEFACTORY_H
 ...
 *
 * <p>
 * When registering a service, a <code>QExtOsgiServiceFactory</code> object can be
 ...
 * <code>QExtOsgiPluginContext::getService(const QExtOsgiServiceReference&)</code> method calls the
 * <code>QExtOsgiServiceFactory::getService</code> method to create a service object
 * specifically for the requesting plugin. The service object returned by the
 * <code>QExtOsgiServiceFactory</code> is cached by the Framework until the plugin
 ...
 * <code>QExtOsgiServiceFactory::ungetService</code> method is called.
 *
 * <p>
 * <code>QExtOsgiServiceFactory</code> objects are only used by the Framework and are
 * not made available to other plugins in the plugin environment. The Framework
 * may concurrently call a <code>QExtOsgiServiceFactory</code>.
 *
 * @see QExtOsgiPluginContext#getService
 * @remarks This class is thread safe.
 */
class QExtOsgiServiceFactory
{
...
public:
   ...
   * <code>QExtOsgiPluginContext::getService(const QExtOsgiServiceReference&)</code> method. The
   ...
   * <code>QExtOsgiPluginContext::getService</code> for the same plugins. This means the
   ...
   * @param registration The <code>QExtOsgiServiceRegistration</code> object for the
   *        service.
   ...
   *
   * @param plugin The QExtOsgiPlugin releasing the service.
   * @param registration The <code>QExtOsgiServiceRegistration</code> object for the
   *        service.
   * @param service The service object returned by a previous call to the
   *        <code>QExtOsgiServiceFactory::getService</code> method.
...
#endif // _QEXTOSGISERVICEFACTORY_H
