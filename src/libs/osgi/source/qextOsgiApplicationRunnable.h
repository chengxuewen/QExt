...
#ifndef _QEXTOSGIAPPLICATIONRUNNABLE_H
#define _QEXTOSGIAPPLICATIONRUNNABLE_H
 ...
 * </p>
 */
struct QEXT_OSGI_API QExtOsgiApplicationRunnable
{
    virtual ~QExtOsgiApplicationRunnable();
...
#endif // _QEXTOSGIAPPLICATIONRUNNABLE_H
