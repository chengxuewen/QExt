...
#ifndef _QEXTOSGITRACKEDPLUGINLISTENER_P_H
#define _QEXTOSGITRACKEDPLUGINLISTENER_P_H
 ...
 */
class QEXT_OSGI_API QExtOsgiTrackedPluginListener : public QObject
{
    Q_OBJECT

public:
    QExtOsgiTrackedPluginListener(QObject *parent = 0)
        : QObject(parent)
    {}
...
#endif // _QEXTOSGITRACKEDPLUGINLISTENER_P_H
