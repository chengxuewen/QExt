 ...
 * </p>
 */
class QExtOsgiDefaultApplicationLauncher : public QObject, public QExtOsgiApplicationLauncher
{
    Q_OBJECT
    Q_INTERFACES(QExtOsgiApplicationLauncher)
...
public:
    ...
    QExtOsgiDefaultApplicationLauncher(QExtOsgiPluginContext* context, bool relaunch, bool failOnNoDefault);
   ...
   * This method assumes that the default application was launched at least once and that a QExtOsgiApplicationDescriptor
...
#endif // _QEXTOSGIDEFAULTAPPLICATIONLAUNCHER_H
