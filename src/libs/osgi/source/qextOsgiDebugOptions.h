...
#ifndef _QEXTOSGIDEBUGOPTIONS_H
#define _QEXTOSGIDEBUGOPTIONS_H
 ...
 */
struct QEXT_OSGI_API QExtOsgiDebugOptions
{

    virtual ~QExtOsgiDebugOptions() {}
   ...
   * For example, <code>org.qext.configadmin/debug</code>
   * </p>
   *
...
Q_DECLARE_INTERFACE(QExtOsgiDebugOptions, "org.qext.service.debug.DebugOptions")

#endif // _QEXTOSGIDEBUGOPTIONS_H
