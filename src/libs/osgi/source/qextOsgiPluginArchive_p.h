...
#ifndef _QEXTOSGIPLUGINARCHIVE_P_H
#define _QEXTOSGIPLUGINARCHIVE_P_H
...
public:
   ...
   * @see QExtOsgiPluginArchive#setAutostartSetting(const QString&)
   */
...
#endif // _QEXTOSGIPLUGINARCHIVE_P_H
