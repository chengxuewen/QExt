...
#ifndef _QEXTOSGIPLUGINFRAMEWORKDEBUG_P_H
#define _QEXTOSGIPLUGINFRAMEWORKDEBUG_P_H
 ...
 */
class QExtOsgiPluginFrameworkDebug
{

public:
    QExtOsgiPluginFrameworkDebug();
...
#endif // _QEXTOSGIPLUGINFRAMEWORKDEBUG_P_H
