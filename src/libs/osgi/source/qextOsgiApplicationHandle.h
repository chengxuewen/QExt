...
#ifndef _QEXTOSGIAPPLICATIONHANDLE_H
#define _QEXTOSGIAPPLICATIONHANDLE_H
...
struct QExtOsgiApplicationDescriptor;
 ...
 */
struct QEXT_OSGI_API QExtOsgiApplicationHandle
{
  ...
  virtual ~QExtOsgiApplicationHandle() {}
   ...
   */
  virtual QExtOsgiApplicationDescriptor* getApplicationDescriptor() const = 0;
   ...
   * application has not terminated then an <code>QExtOsgiApplicationException</code>
   * is thrown.</li>
   *
   ...
   * terminated then an <code>QExtOsgiApplicationException</code> is thrown.</li>
   * </ul>
   *
   ...
   * @throws QextUnsupportedOperationException If the application model does not
   *         support exit values.
   * @throws QExtOsgiApplicationException If the application has not terminated. The
   *         error code will be
   *         QExtOsgiApplicationException::APPLICATION_EXITVALUE_NOT_AVAILABLE.
   */
   ...
   * <p>
   * At the end the <code>QExtOsgiApplicationHandle</code> must be unregistered.
   * This method should  free all the resources related to this
   * <code>QExtOsgiApplicationHandle</code>.
   * <p>
...
Q_DECLARE_INTERFACE(QExtOsgiApplicationHandle, "org.qext.service.application.ApplicationHandle")

#endif // _QEXTOSGIAPPLICATIONHANDLE_H
