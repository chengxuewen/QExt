...
Dialog {
    ...
    property string contentText: "QEXTDialog content"
    ...
    property list<QEXTDialogButton> buttons
    property list<QEXTDialogButton> defaultButtons: [
        QEXTDialogButton {
            lighter: true
            text: "Enter"
            textFont.bold: true
