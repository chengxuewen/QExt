...
static inline QEXTVLCVideoMemoryStream *p_this(void *opaque)
{
    return static_cast<QEXTVLCVideoMemoryStream *>(opaque);
}
static inline QEXTVLCVideoMemoryStream *p_this(void **opaque)
{
    return static_cast<QEXTVLCVideoMemoryStream *>(*opaque);
...
QEXTVLCVideoMemoryStream::QEXTVLCVideoMemoryStream() { }
...
unsigned QEXTVLCVideoMemoryStream::setPitchAndLines(const vlc_chroma_description_t *desc,
        unsigned width,
        unsigned height,
        unsigned *pitches,
        unsigned *lines,
...
void QEXTVLCVideoMemoryStream::setCallbacks(QEXTVLCMediaPlayer *player)
{
...
void QEXTVLCVideoMemoryStream::unsetCallbacks(QEXTVLCMediaPlayer *player)
{
...
void *QEXTVLCVideoMemoryStream::lockCallbackInternal(void *opaque,
        void **planes)
{
    return P_THIS->lockCallback(planes);
}

void QEXTVLCVideoMemoryStream::unlockCallbackInternal(void *opaque,
        void *picture,
        void *const *planes)
{
...
void QEXTVLCVideoMemoryStream::displayCallbackInternal(void *opaque,
        void *picture)
{
    P_THIS->displayCallback(picture);
}

unsigned QEXTVLCVideoMemoryStream::formatCallbackInternal(void **opaque,
        char *chroma,
        unsigned *width,
        unsigned *height,
        unsigned *pitches,
...
void QEXTVLCVideoMemoryStream::formatCleanUpCallbackInternal(void *opaque)
{
