...
QEXTTcpTaskThreadPool::QEXTTcpTaskThreadPool(QObject *parent)
    : QEXTTcpThreadPoolBase(*(new QEXTTcpTaskThreadPoolPrivate(this)), parent)
{
...
void QEXTTcpTaskThreadPool::setTcpThreadIdle(QEXTTcpThreadBase *thread)
{
    QEXTTcpThreadPoolBase::setTcpThreadIdle(thread);
...
void QEXTTcpTaskThreadPool::dispatchThreadHandleTask()
{
    ...
    if (!d->m_taskPool->isTaskEmpty()) {
        ...
        if (threadsNum > 0) {
            QEXTTcpThreadBase *thread = d->m_idleThreadsQueue.dequeue();
...
void QEXTTcpTaskThreadPool::setTaskPool(QSharedPointer<QEXTTcpTaskPoolBase> taskPool)
{
    QEXT_D(QEXTTcpTaskThreadPool);
