...
QEXTTcpPacket::QEXTTcpPacket(QEXTTcpPacketHeaderBase *header, const QEXTId &id)
...
QEXTTcpPacket::QEXTTcpPacket(QEXTTcpPacketHeaderBase *header, QEXTTcpPacketPrivate &dd, const QEXTId &id)
    : QEXTObject(dd)
{
    QEXT_D(QEXTTcpPacket);
    d->m_socketId = id;
...
QEXTTcpPacketHeaderBase *QEXTTcpPacket::header() const
{
    QEXT_DC(QEXTTcpPacket);
    return d->m_header.data();
}

bool QEXTTcpPacket::setHeader(QEXTTcpPacketHeaderBase *header)
{
    QEXT_D(QEXTTcpPacket);
    d->m_header.reset(header);
    return true;
