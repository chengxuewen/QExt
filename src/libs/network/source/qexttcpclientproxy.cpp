...
void QEXTTcpClientProxyPrivate::setRequestFlag(QEXTTcpPacketBase *send)
{
...
void QEXTTcpClientProxyPrivate::setSyncRequestReplyFlag(QEXTTcpPacketBase *reply)
{
...
QEXTTcpPacketBase *QEXTTcpClientProxy::sendPacket() const
{
    QEXT_DC(QEXTTcpClientProxy);
    QMutexLocker mutexLocker(&d->m_mutex);
...
QEXTTcpPacketParserBase *QEXTTcpClientProxy::packetParser() const
{
    QEXT_DC(QEXTTcpClientProxy);
    return d->m_packetParser.data();
}

void QEXTTcpClientProxy::setPacketParser(QEXTTcpPacketParserBase *packetParser)
{
    QEXT_D(QEXTTcpClientProxy);
    d->m_packetParser.reset(packetParser);
}

bool QEXTTcpClientProxy::sendSyncRequestPacket(QEXTTcpPacketBase *send, QEXTTcpPacketBase **rcv)
{
    QEXT_D(QEXTTcpClientProxy);
...
bool QEXTTcpClientProxy::sendRequestPacket(QEXTTcpPacketBase *send)
{
    QEXT_D(QEXTTcpClientProxy);
    if (!d->m_socket->isOpen()) {
...
bool QEXTTcpClientProxy::sendReplyPacket(QEXTTcpPacketBase *send)
{
    QEXT_D(QEXTTcpClientProxy);
    if (!d->m_socket->isOpen()) {
...
bool QEXTTcpClientProxy::sendNotifyPacket(QEXTTcpPacketBase *send)
{
    QEXT_D(QEXTTcpClientProxy);
    if (!d->m_socket->isOpen()) {
...
void QEXTTcpClientProxy::enqueuePacket(QEXTTcpPacketBase *packet)
{
    if (packet) {
        QEXT_D(QEXTTcpClientProxy);
        d->m_mutex.lock();
...
QEXTTcpPacketBase *QEXTTcpClientProxy::dequeuePacket()
{
    QEXT_D(QEXTTcpClientProxy);
    QMutexLocker mutexLocker(&d->m_packetQueueMutex);
