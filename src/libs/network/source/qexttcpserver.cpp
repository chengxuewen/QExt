...
void QEXTTcpServerPrivate::initServer()
{
    ...
    qRegisterMetaType<QSharedPointer<QEXTTcpTaskPoolBase> >("QSharedPointer<QEXTTcpTaskPoolBase>");
...
QEXTTcpServer::QEXTTcpServer(QEXTTcpPacketParserBase *packetParser, QObject *parent)
    : QTcpServer(parent), QEXTObject(*(new QEXTTcpServerPrivate(this)))
{
    QEXT_D(QEXTTcpServer);
    d->initServer();
...
QEXTTcpServer::QEXTTcpServer(QEXTTcpPacketParserBase *packetParser, QEXTTcpTaskPoolBase *taskPool, QObject *parent)
    : QTcpServer(parent), QEXTObject(*(new QEXTTcpServerPrivate(this)))
{
    QEXT_D(QEXTTcpServer);
    d->initServer();
...
QEXTTcpServer::QEXTTcpServer(QEXTTcpServerPrivate &dd, QEXTTcpPacketParserBase *packetParser, QObject *parent)
    : QTcpServer(parent), QEXTObject(dd)
{
    QEXT_D(QEXTTcpServer);
    d->initServer();
...
QEXTTcpServer::QEXTTcpServer(QEXTTcpServerPrivate &dd, QEXTTcpPacketParserBase *packetParser,
                             QEXTTcpTaskPoolBase *taskPool, QObject *parent)
    : QTcpServer(parent), QEXTObject(dd)
{
    QEXT_D(QEXTTcpServer);
    d->initServer();
...
QEXTTcpPacketParserBase *QEXTTcpServer::packetParser() const
{
    QEXT_DC(QEXTTcpServer);
    return d->m_packetParser.data();
}

void QEXTTcpServer::setPacketParser(QEXTTcpPacketParserBase *packetParser)
{
    QEXT_D(QEXTTcpServer);
...
QEXTTcpTaskPoolBase *QEXTTcpServer::taskPool() const
{
    QEXT_DC(QEXTTcpServer);
    return d->m_taskPool.data();
}

void QEXTTcpServer::setTaskPool(QEXTTcpTaskPoolBase *taskPool)
{
    QEXT_D(QEXTTcpServer);
    if (taskPool && taskPool != d->m_taskPool.data()) {
        ...
        d->m_taskPool = QSharedPointer<QEXTTcpTaskPoolBase>(taskPool);
