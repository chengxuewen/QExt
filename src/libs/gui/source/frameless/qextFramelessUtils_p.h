...
#ifndef _QEXTFRAMELESSUTILS_P_H
#define _QEXTFRAMELESSUTILS_P_H
...
public:
    explicit WindowMoveManipulator(QWindow *targetWindow)
        : QObject(targetWindow), target(targetWindow), initialMousePosition(QCursor::pos()), initialWindowPosition(
