...
#ifndef _QEXTFRAMELESS_WIN_H
#define _QEXTFRAMELESS_WIN_H
...
QEXT_GUI_API RTL_OSVERSIONINFOW GetRealOSVersion();
...
//
#if QT_VERSION < QT_VERSION_CHECK(5, 14, 0)
class QEXT_GUI_API WindowsRegistryKey
{
public:
