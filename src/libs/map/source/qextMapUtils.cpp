...
static_assert(mbgl::underlying_type(QExtMapLibre::Online) == mbgl::underlying_type(mbgl::NetworkStatus::Status::Online),
              "error");
static_assert(mbgl::underlying_type(QExtMapLibre::Offline) == mbgl::underlying_type(mbgl::NetworkStatus::Status::Offline),
              "error");
