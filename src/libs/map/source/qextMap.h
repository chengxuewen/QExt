...
class QEXT_MAP_API Map : public QObject {
    Q_OBJECT
    ...
    Q_PROPERTY(QExtMapLibre::Coordinate coordinate READ coordinate WRITE setCoordinate)
...
Q_DECLARE_METATYPE(QExtMapLibre::Map::MapChange);
Q_DECLARE_METATYPE(QExtMapLibre::Map::MapLoadingFailure);
