...
// mbgl::FeatureType
static_assert(mbgl::underlying_type(QExtMapLibre::Feature::PointType) == mbgl::underlying_type(mbgl::FeatureType::Point),
              "error");
static_assert(mbgl::underlying_type(QExtMapLibre::Feature::LineStringType) ==
                  mbgl::underlying_type(mbgl::FeatureType::LineString),
              "error");
static_assert(mbgl::underlying_type(QExtMapLibre::Feature::PolygonType) ==
