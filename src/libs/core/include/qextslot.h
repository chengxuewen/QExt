...
struct QEXTSlotCall7
{
    static T_return callIt(QEXTSlotRepresentation *rep,
        ...
        return typedRep->m_functor(arg1, arg2, arg3, arg4, arg5, arg6, arg7);
    }
...
struct QEXTSlotCall6
{
    static T_return callIt(QEXTSlotRepresentation *rep,
        ...
        typedef QEXTTypedSlotRepresentation<T_functor> TypedSlot;
        TypedSlot *typedRep = static_cast<TypedSlot*>(rep);
        return typedRep->m_functor(arg1, arg2, arg3, arg4, arg5, arg6);
    }
...
struct QEXTSlotCall5
{
    static T_return callIt(QEXTSlotRepresentation *rep,
        ...
        typedef QEXTTypedSlotRepresentation<T_functor> TypedSlot;
        TypedSlot *typedRep = static_cast<TypedSlot*>(rep);
        return typedRep->m_functor(arg1, arg2, arg3, arg4, arg5);
    }
...
struct QEXTSlotCall4
{
    static T_return callIt(QEXTSlotRepresentation *rep,
        ...
        typedef QEXTTypedSlotRepresentation<T_functor> TypedSlot;
        TypedSlot *typedRep = static_cast<TypedSlot*>(rep);
        return typedRep->m_functor(arg1, arg2, arg3, arg4);
    }
...
struct QEXTSlotCall3
{
    static T_return callIt(QEXTSlotRepresentation *rep,
        ...
        typedef QEXTTypedSlotRepresentation<T_functor> TypedSlot;
        TypedSlot *typedRep = static_cast<TypedSlot*>(rep);
        return typedRep->m_functor(arg1, arg2, arg3);
    }
...
struct QEXTSlotCall2
{
    static T_return callIt(QEXTSlotRepresentation *rep,
        ...
        typedef QEXTTypedSlotRepresentation<T_functor> TypedSlot;
        TypedSlot *typedRep = static_cast<TypedSlot*>(rep);
        return typedRep->m_functor(arg1, arg2);
    }
...
struct QEXTSlotCall1
{
    static T_return callIt(QEXTSlotRepresentation *rep,
        ...
        typedef QEXTTypedSlotRepresentation<T_functor> TypedSlot;
        TypedSlot *typedRep = static_cast<TypedSlot*>(rep);
        return typedRep->m_functor(arg1);
    }
...
public:
    ...
    QEXTSlot3() {}
    template <typename T_functor>
    QEXTSlot3(const T_functor &func) : QEXTSlotBase(new qextinternal::QEXTTypedSlotRepresentation<T_functor>(func)) {
    ...
    T_return operator()(Arg1Type arg1, Arg2Type arg2, Arg3Type arg3) const {
        if (!isEmpty() && !isBlocked()) {
            return (reinterpret_cast<CallType>(QEXTSlotBase::m_slotRep->m_call))(QEXTSlotBase::m_slotRep, arg1, arg2, arg3);
        }
        return T_return();
    }
...
public:
    ...
    QEXTSlot4() {}
    template <typename T_functor>
    QEXTSlot4(const T_functor &func) : QEXTSlotBase(new qextinternal::QEXTTypedSlotRepresentation<T_functor>(func)) {
    ...
    T_return operator()(Arg1Type arg1, Arg2Type arg2, Arg3Type arg3, Arg4Type arg4) const {
        if (!isEmpty() && !isBlocked()) {
            return (reinterpret_cast<CallType>(QEXTSlotBase::m_slotRep->m_call))(QEXTSlotBase::m_slotRep, arg1, arg2, arg3, arg4);
        }
        return T_return();
    }
...
public:
    ...
    QEXTSlot5() {}
    template <typename T_functor>
    QEXTSlot5(const T_functor &func) : QEXTSlotBase(new qextinternal::QEXTTypedSlotRepresentation<T_functor>(func)) {
    ...
    T_return operator()(Arg1Type arg1, Arg2Type arg2, Arg3Type arg3, Arg4Type arg4, Arg5Type arg5) const {
        if (!isEmpty() && !isBlocked()) {
            return (reinterpret_cast<CallType>(QEXTSlotBase::m_slotRep->m_call))(QEXTSlotBase::m_slotRep, arg1, arg2, arg3, arg4, arg5);
        }
        return T_return();
    }
...
public:
    ...
    QEXTSlot6() {}
    template <typename T_functor>
    QEXTSlot6(const T_functor &func) : QEXTSlotBase(new qextinternal::QEXTTypedSlotRepresentation<T_functor>(func)) {
    ...
    T_return operator()(Arg1Type arg1, Arg2Type arg2, Arg3Type arg3, Arg4Type arg4, Arg5Type arg5, Arg6Type arg6) const {
        if (!isEmpty() && !isBlocked()) {
            return (reinterpret_cast<CallType>(QEXTSlotBase::m_slotRep->m_call))(QEXTSlotBase::m_slotRep, arg1, arg2, arg3, arg4, arg5, arg6);
        }
        return T_return();
    }
...
public:
    ...
    QEXTSlot7() {}
    template <typename T_functor>
    QEXTSlot7(const T_functor &func) : QEXTSlotBase(new qextinternal::QEXTTypedSlotRepresentation<T_functor>(func)) {
    ...
    T_return operator()(Arg1Type arg1, Arg2Type arg2, Arg3Type arg3, Arg4Type arg4, Arg5Type arg5, Arg6Type arg6, Arg7Type arg7) const {
        if (!isEmpty() && !isBlocked()) {
            return (reinterpret_cast<CallType>(QEXTSlotBase::m_slotRep->m_call))(QEXTSlotBase::m_slotRep, arg1, arg2, arg3, arg4, arg5, arg6, arg7);
        }
        return T_return();
    }
