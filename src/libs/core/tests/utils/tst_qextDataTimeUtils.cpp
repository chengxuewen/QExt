...
void QExtDateTimeUtilsTest::sleep500msTest()
{
    ...
    QElapsedTimer timer;
    timer.start();
    QExtDateTimeUtils::loopWait(500);
    qint64 elapse = timer.elapsed();
