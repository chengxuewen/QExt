#ifndef QEXTVISITORTEST_H
#define QEXTVISITORTEST_H
...
namespace qextVisitorTest
{
    ...
    class MTrackableClass1 : QEXTObject
    {
    public:
    ...
    class MyClass1 : public QEXTObject
    {
    public:
    ...
    class MyClass2 : public NsExtClass, public QEXTObject
    {
    public:
    ...
    TEST_GROUP(qextVisitorTest)
    {
    };

    TEST(qextVisitorTest, testTypeVisitor)
    {
        ...
        CHECK("MClass1::exec:0" == sg_string);
    ...
    TEST(qextVisitorTest, testCase1)
    {
    ...
    TEST(qextVisitorTest, testCase2)
    {
    ...
    TEST(qextVisitorTest, testCase3)
    {
...
template <typename T_functor>
struct QEXTVisitor<qextVisitorTest::MyAdaptor1<T_functor> >
{
    template <typename T_action>
    static void doVisitEach(const T_action &action,
                            const qextVisitorTest::MyAdaptor1<T_functor> &target)
    {
        qextVisitEach(action, target.m_functor);
    }
};
