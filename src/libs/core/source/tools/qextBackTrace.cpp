...
#   define QEXT_HAVE_EXECINFO
#   define QEXT_HAVE_DLADDR
#endif

#if defined(__GNUC__)
#   define QEXT_HAVE_ABI_CXA_DEMANGLE
#endif

#ifdef QEXT_HAVE_EXECINFO
#   include <execinfo.h>
#endif

#ifdef QEXT_HAVE_ABI_CXA_DEMANGLE
#   include <cxxabi.h>
#endif

#ifdef QEXT_HAVE_DLADDR
#   include <dlfcn.h>
#endif
...
QExtBackTrace::QExtBackTrace(size_t framesNumber)
    : d(new QExtBackTracePrivate)
{
    if(framesNumber == 0)
    {
        return;
