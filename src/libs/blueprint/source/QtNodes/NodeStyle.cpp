...
QExtBPNodeStyle::QExtBPNodeStyle()
{
...
QExtBPNodeStyle::QExtBPNodeStyle(QString jsonText)
{
...
void QExtBPNodeStyle::setNodeStyle(QString jsonText)
{
    QExtBPNodeStyle style(jsonText);

    QExtBPStyleCollection::setNodeStyle(style);
}
...
QJsonObject QExtBPNodeStyle::toJson() const
{
    QJsonObject obj;
