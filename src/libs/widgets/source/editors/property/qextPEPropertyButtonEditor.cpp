#include <qextPEPropertyButtonEditor.h>
...
{
    QExtPEPropertyButtonEditor *q_ptr;
    Q_DECLARE_PUBLIC(QExtPEPropertyButtonEditor)
public:
...
QToolButton *QExtPEPropertyButtonEditorPrivate::createButton(QWidget *parent) const
{
...
int QExtPEPropertyButtonEditorPrivate::gridRow(WidgetItem *item) const
{
...
int QExtPEPropertyButtonEditorPrivate::gridSpan(WidgetItem *item) const
{
...
void QExtPEPropertyButtonEditorPrivate::init(QWidget *parent)
{
...
void QExtPEPropertyButtonEditorPrivate::slotEditorDestroyed()
{
...
void QExtPEPropertyButtonEditorPrivate::slotUpdate()
{
...
void QExtPEPropertyButtonEditorPrivate::setExpanded(WidgetItem *item, bool expanded)
{
...
void QExtPEPropertyButtonEditorPrivate::slotToggled(bool checked)
{
...
void QExtPEPropertyButtonEditorPrivate::updateLater()
{
    QTimer::singleShot(0, q_ptr, SLOT(slotUpdate()));
}

void QExtPEPropertyButtonEditorPrivate::propertyInserted(QExtPEPropertyItem *index, QExtPEPropertyItem *afterIndex)
{
...
void QExtPEPropertyButtonEditorPrivate::propertyRemoved(QExtPEPropertyItem *index)
{
...
void QExtPEPropertyButtonEditorPrivate::insertRow(QGridLayout *layout, int row) const
{
...
void QExtPEPropertyButtonEditorPrivate::removeRow(QGridLayout *layout, int row) const
{
    QMap<QLayoutItem *, QRect> itemToPos;
    int idx = 0;
    while (idx < layout->count())
...
void QExtPEPropertyButtonEditorPrivate::propertyChanged(QExtPEPropertyItem *index)
{
    WidgetItem *item = m_indexToItem.value(index);
    this->updateItem(item);
}

void QExtPEPropertyButtonEditorPrivate::updateItem(WidgetItem *item)
{
...
QExtPEPropertyButtonEditor::QExtPEPropertyButtonEditor(QWidget *parent)
    : QExtPEAbstractPropertyEditor(parent)
{
    dd_ptr = new QExtPEPropertyButtonEditorPrivate;
    dd_ptr->q_ptr = this;

    dd_ptr->init(this);
}

QExtPEPropertyButtonEditor::~QExtPEPropertyButtonEditor()
{
    QMap<QExtPEPropertyButtonEditorPrivate::WidgetItem *, QExtPEPropertyItem *>::ConstIterator  it;
...
void QExtPEPropertyButtonEditor::itemInserted(QExtPEPropertyItem *item, QExtPEPropertyItem *afterItem)
{
    dd_ptr->propertyInserted(item, afterItem);
}

void QExtPEPropertyButtonEditor::itemRemoved(QExtPEPropertyItem *item)
{
    dd_ptr->propertyRemoved(item);
}

void QExtPEPropertyButtonEditor::itemChanged(QExtPEPropertyItem *item)
{
    dd_ptr->propertyChanged(item);
}

void QExtPEPropertyButtonEditor::setExpanded(QExtPEPropertyItem *item, bool expanded)
{
    QExtPEPropertyButtonEditorPrivate::WidgetItem *itm = dd_ptr->m_indexToItem.value(item);
    if (itm)
    {
        dd_ptr->setExpanded(itm, expanded);
    }
}

bool QExtPEPropertyButtonEditor::isExpanded(QExtPEPropertyItem *item) const
{
    QExtPEPropertyButtonEditorPrivate::WidgetItem *itm = dd_ptr->m_indexToItem.value(item);
    if (itm)
    {
...
#include <moc_qextPEPropertyButtonEditor.cpp>
