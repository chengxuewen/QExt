...
class QEXT_WIDGETS_API QEXTNavListWidgetItem : public QObject
{
    Q_OBJECT
public:
...
class QEXT_WIDGETS_API QEXTNavListModel : public QAbstractListModel
{
    Q_OBJECT
public:
...
class QEXT_WIDGETS_API QEXTNavListWidget : public QWidget
{
    Q_OBJECT
