...
class QEXTNavButton;
class QEXT_WIDGETS_API QEXTNavButtonPrivate
{
public:
    ...
    QEXTNavButton::TextAlign m_textAlign; //文字对齐

    bool m_triangleVisiable;                 //显示倒三角
    QEXTNavButton::Position m_trianglePosition; //倒三角位置
    int m_triangleLen;                   //倒三角边长
    QColor m_triangleColor;              //倒三角颜色

    bool m_iconVisiable;      //显示图标
    QEXTNavButton::Position m_iconPosition;
    ...
    QEXTNavButton::Position m_linePosition; //线条位置
