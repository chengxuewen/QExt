    ...
    : QMainWindow(parent)
{
    ...
    doubleManager = new QExtPEDoublePropertyManager(this);
    stringManager = new QExtPEStringPropertyManager(this);
    colorManager = new QExtPEColorPropertyManager(this);
    fontManager = new QExtPEFontPropertyManager(this);
    pointManager = new QExtPEPointPropertyManager(this);
    sizeManager = new QExtPESizePropertyManager(this);

    connect(doubleManager, SIGNAL(valueChanged(QExtPEProperty *, double)),
                this, SLOT(valueChanged(QExtPEProperty *, double)));
    connect(stringManager, SIGNAL(valueChanged(QExtPEProperty *, const QString &)),
                this, SLOT(valueChanged(QExtPEProperty *, const QString &)));
    connect(colorManager, SIGNAL(valueChanged(QExtPEProperty *, const QColor &)),
                this, SLOT(valueChanged(QExtPEProperty *, const QColor &)));
    connect(fontManager, SIGNAL(valueChanged(QExtPEProperty *, const QFont &)),
                this, SLOT(valueChanged(QExtPEProperty *, const QFont &)));
    connect(pointManager, SIGNAL(valueChanged(QExtPEProperty *, const QPoint &)),
                this, SLOT(valueChanged(QExtPEProperty *, const QPoint &)));
    connect(sizeManager, SIGNAL(valueChanged(QExtPEProperty *, const QSize &)),
                this, SLOT(valueChanged(QExtPEProperty *, const QSize &)));

    QExtPEDoubleSpinBoxFactory *doubleSpinBoxFactory = new QExtPEDoubleSpinBoxFactory(this);
    QExtPECheckBoxFactory *checkBoxFactory = new QExtPECheckBoxFactory(this);
    QExtPESpinBoxFactory *spinBoxFactory = new QExtPESpinBoxFactory(this);
    QExtPELineEditFactory *lineEditFactory = new QExtPELineEditFactory(this);
    QExtPEEnumEditorFactory *comboBoxFactory = new QExtPEEnumEditorFactory(this);
    ...
    propertyEditor = new QExtPEPropertyTreeEditor(dock);
...
{
    QList<QExtPEPropertyItem *> list = propertyEditor->topLevelItems();
    QListIterator<QExtPEPropertyItem *> it(list);
    while (it.hasNext()) {
        QExtPEPropertyItem *item = it.next();
        QExtPEProperty *prop = item->property();
...
void MainWindow::itemClicked(QtCanvasItem *item)
{
    ...
    QMap<QExtPEProperty *, QString>::ConstIterator itProp = propertyToId.constBegin();
...
void MainWindow::addProperty(QExtPEProperty *property, const QString &id)
{
    propertyToId[property] = id;
    idToProperty[id] = property;
    QExtPEPropertyItem *item = propertyEditor->addProperty(property);
    if (idToExpanded.contains(id))
        propertyEditor->setExpanded(item, idToExpanded[id]);
}

void MainWindow::valueChanged(QExtPEProperty *property, double value)
{
...
void MainWindow::valueChanged(QExtPEProperty *property, const QString &value)
{
    if (!propertyToId.contains(property))
        return;
...
void MainWindow::valueChanged(QExtPEProperty *property, const QColor &value)
{
    if (!propertyToId.contains(property))
        return;
...
void MainWindow::valueChanged(QExtPEProperty *property, const QFont &value)
{
    if (!propertyToId.contains(property))
        return;
...
void MainWindow::valueChanged(QExtPEProperty *property, const QPoint &value)
{
    if (!propertyToId.contains(property))
        return;
...
void MainWindow::valueChanged(QExtPEProperty *property, const QSize &value)
{
    if (!propertyToId.contains(property))
        return;
