    ...
    : QMainWindow(parent)
{
    ...
    variantManager = new QExtPEVariantPropertyManager(this);

    connect(variantManager, SIGNAL(valueChanged(QExtPEProperty *, const QVariant &)),
                this, SLOT(valueChanged(QExtPEProperty *, const QVariant &)));

    QExtPEVariantEditorFactory *variantFactory = new QExtPEVariantEditorFactory(this);
...
void MainWindow::addProperty(QExtPEVariantProperty *property, const QString &id)
{
...
void MainWindow::valueChanged(QExtPEProperty *property, const QVariant &value)
{
