...
int main(int argc, char **argv)
{
    ...
    QExtPEVariantPropertyManager *variantManager = new QExtPEVariantPropertyManager();

    int i = 0;
    QExtPEProperty *topItem = variantManager->addProperty(QExtPEVariantPropertyManager::groupTypeId(),
                                                        QString::number(i++) + QLatin1String(" Group Property"));

    QExtPEVariantProperty *item = variantManager->addProperty(QVariant::Bool, QString::number(i++) + QLatin1String(" Bool Property"));
    item->setValue(true);
    ...
    item = variantManager->addProperty(QExtPEVariantPropertyManager::enumTypeId(),
    ...
    item = variantManager->addProperty(QExtPEVariantPropertyManager::flagTypeId(),
    ...
    QExtPEPropertyTreeEditor *variantEditor = new QExtPEPropertyTreeEditor();
