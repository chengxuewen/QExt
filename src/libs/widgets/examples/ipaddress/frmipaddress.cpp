...
{
    ui->setupUi(this);
    ui->widgetIP->setBackgroundColor(Qt::white);
//    ui->widgetIP->setBackgroundColor(Qt::black);
//    ui->widgetIP->setBackgroundColor("#FF0000");
//    ui->widgetIP->setTextColor(Qt::red);
    ui->widgetIP->setDotColor(Qt::red);
}
