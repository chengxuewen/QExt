...
void frmTumbler::initForm()
{
    ...
    ui->tumbler2->setValueList(listValue);
    ui->tumbler3->setValueList(listValue);
    ...
    ui->tumbler5->setValueList(listValue);
