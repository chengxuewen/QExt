...
void frmWaveChart::initForm()
{
    ...
    ui->waveChart1->setYAxisStep(30);
    ui->waveChart1->setHLineStep(30);
    ui->waveChart1->setVLineStep(30);
...
{
    bool show = (arg1 != 0);
    ui->waveChart1->setSmoothEnable(show);
    ui->waveChart2->setSmoothEnable(show);
}
