...
{
    bool ok = (arg1 != 0);
    ui->progressRing1->setAnimationEnable(ok);
    ui->progressRing2->setAnimationEnable(ok);
    ui->progressRing3->setAnimationEnable(ok);
    ui->progressRing4->setAnimationEnable(ok);
    ui->progressRing5->setAnimationEnable(ok);
    ui->progressRing6->setAnimationEnable(ok);
}
