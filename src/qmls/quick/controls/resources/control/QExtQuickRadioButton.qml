...
RadioButton {
    ...
    onCheckedChanged: {
        qextRadioButton.state = qextRadioButton.checked ? QExtQuickControls.stateToString(QExtQuickControls.State_Checked) :
                                                          QExtQuickControls.stateToString(QExtQuickControls.State_Unchecked)
    }
