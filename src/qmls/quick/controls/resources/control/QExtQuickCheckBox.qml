...
CheckBox {
    ...
    onCheckStateChanged: {
        if (Qt.Unchecked === checkState) {
            qextCheckBox.state = QExtQuickControls.stateToString(QExtQuickControls.State_Unchecked)
        } else if (Qt.PartiallyChecked === checkState) {
            qextCheckBox.state = QExtQuickControls.stateToString(QExtQuickControls.State_PartiallyChecked)
        } else if (Qt.Checked === checkState) {
            qextCheckBox.state = QExtQuickControls.stateToString(QExtQuickControls.State_Checked)
        }
    }
}
