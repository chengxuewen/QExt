            ...
            Row {
                ...
                QExtQuickSVGIcon {
                    ...
                    source: {
                        switch(_super.type) {
                            case mControl.const_success:
                            return "qrc:/QExtQuickControls/svg/success.svg"
                            case mControl.const_warning:
                            return "qrc:/QExtQuickControls/svg/warning.svg"
                            case mControl.const_info:
                            return "qrc:/QExtQuickControls/svg/info.svg"
                            case mControl.const_error:
                            return "qrc:/QExtQuickControls/svg/error.svg"
                        }
                        return "#FFFFFF"
                    }
