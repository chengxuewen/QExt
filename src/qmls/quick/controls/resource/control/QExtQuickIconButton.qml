...
QExtQuickButton {
    ...
    function contentItemComponent() {
        if (QExtQuickControls.IconDisplay_TextOnly === qextIconButton.iconDisplay) {
            return mContentTextOnlyComponent
        } else if (QExtQuickControls.IconDisplay_IconOnly === qextIconButton.iconDisplay) {
            return mContentIconOnlyComponent
        } else if (QExtQuickControls.IconDisplay_Left === qextIconButton.iconDisplay) {
            return mContentIconLeftComponent
        } else if (QExtQuickControls.IconDisplay_Right === qextIconButton.iconDisplay) {
            return mContentIconRightComponent
        } else if (QExtQuickControls.IconDisplay_Top === qextIconButton.iconDisplay) {
            return mContentIconTopComponent
        } else if (QExtQuickControls.IconDisplay_Bottom === qextIconButton.iconDisplay) {
