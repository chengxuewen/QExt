#ifndef _QEXTQUICKCONTROLSCONSTANT_H
#define _QEXTQUICKCONTROLSCONSTANT_H
...
QEXT_STATIC_CONSTANT_STRING(kButtonStateUnchecked, "Unchecked")
// QEXT_STATIC_CONSTANT_STRING(kButtonStatePartiallyChecked, "PartiallyChecked")
} // namespace QExtQuickControlsConstant

#endif // _QEXTQUICKCONTROLSCONSTANT_H
