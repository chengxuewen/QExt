...
Window {
    id:root
    visible: true
    title: "Music player by Toou 2D - FPS:" + fps.fpsAvg + "," + fps.fps;
    width: 990
    height: 630 + 30
    minimumWidth: 990;
    ...
    TRectangle{
        ...
        TNavigationBar{
            ...
            onTriggered: {
                ...
                case "个性推荐": contentPageLoader.openHomPage();    break;
                case "歌手":    contentPageLoader.openSingerPage(); break;
                case "排行榜":  contentPageLoader.openHotPage();     break;
                case "电台":    contentPageLoader.openFmPage();     break;
                case "歌手":    contentPageLoader.openSingerPage(); break;
                }
    ...
    TRectangle{
        ...
        Column{
            ...
            TIconButton{
                ...
                label.text: root.global.userName ? root.global.userName : "登陆Toou音乐"
                ...
                Repeater{
                    ...
                    delegate: TIconButton{
                        ...
                        onClicked:{
                            ...
                            switch(index){
                            case 0: contentPageLoader.openHomPage();break;
                            case 1: contentPageLoader.openMvPage("今日推荐：一场游戏一场梦 - 王杰");break;
                            case 2: contentPageLoader.openHotPage(); break;
                            case 3: contentPageLoader.openFmPage(); break;
                            case 4: contentPageLoader.openDownloadPage();break;
                            case 5: contentPageLoader.openSingerPage();break;
                            }
    ...
    Q.Dialog_login{
        ...
        onLogin: {
            ...
            TToast.showSuccess("欢迎使用Toou音乐",TToast.longTime);
