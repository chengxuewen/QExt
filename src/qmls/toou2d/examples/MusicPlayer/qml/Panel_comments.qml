...
Column{
    ...
    Item{
        ...
        TInputField{
            ...
            placeholderLabel.text: "畅所欲言，期待你的神评论";
        ...
        TButton{
            ...
            onClicked: {
                if(!root.global.userName){
                    TToast.showError("留下大名",TTimePreset.LongTime4s,"敢问高僧从何而来？");
                    root.loginDialog.open();
                }
                else{
                    TToast.showMessage("发表成功",TToast.shortTime);
