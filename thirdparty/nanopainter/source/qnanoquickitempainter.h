...
#include <qnanopainterglobal.h>
#ifdef QNANO_USE_RENDERNODE
class QNANOPAINTER_API QNanoQuickItemPainter : public QSGRenderNode, protected QOpenGLFunctions
#else
class QNANOPAINTER_API QNanoQuickItemPainter : public QQuickFramebufferObject::Renderer, protected QOpenGLFunctions
#endif
{
