---
name: doc-audit
description: "QExt 项目文档与架构审计。并行检查架构文档、设计文档、决策记录之间的自洽性、完整性、缺口和优化机会。以交互式问答与用户逐项确认每项发现，列出详情、方案与优劣、来源、影响、推荐。支持团队模式(大型审计)和背景代理模式(轻量检查)。"
---

# 文档架构审计 (Document & Architecture Audit)

对 QExt 项目文档体系进行全面审计，覆盖文档一致性、决策验证、agent 基础设施、参考对标。
