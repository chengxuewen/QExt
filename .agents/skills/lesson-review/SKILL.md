...
```
- 技术陷阱 → {pitfall_log}      # QExt: .agents/memorys/pitfalls.md
- 开发约束 → {conventions}       # QExt: .agents/memorys/conventions.md
- 架构决策 → {decisions}         # QExt: .agents/memorys/decisions.md
- 可执行检查 → {checks}          # QExt: .agents/rules/common/edit-safety.md
- 测试要求 → {test_rules}        # QExt: .agents/rules/common/testing.md
- 安全规则 → {security_rules}    # QExt: .agents/rules/common/security.md
- 项目状态 → {status}            # QExt: .agents/memorys/status.md
```
