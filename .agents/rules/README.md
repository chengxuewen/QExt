...
1. Create an `.agents/rules/go/` directory
...
- `.agents/rules/cpp/`, and any future language dirs override those defaults where language idioms differ.

### Example

`common/coding-style.md` recommends immutability as a default principle. A language-specific `cpp/coding-style.md` can override this:

> RAII/值语义优先 — see [common/coding-style.md](../common/coding-style.md) for the general principle, but C++ move semantics make explicit ownership transfer idiomatic here.
