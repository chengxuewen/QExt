...
public:
    ...
    struct HandleInfo
    {
        HandleInfo(SizeHandleElement::EHandlePosition p, Qt::CursorShape c, SizeHandleElement::EHandlePosition o, std::function<QPointF(const QRectF&)> f)
            : position(p), cursor(c), opposite_position(o), rect_to_pos(f) {}
