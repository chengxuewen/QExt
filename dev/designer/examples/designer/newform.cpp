...
NewForm::NewForm(QDesignerWorkbench *workbench, QWidget *parentWidget, const QString &fileName)
    : QDialog(parentWidget, Qt::WindowTitleHint | Qt::WindowSystemMenuHint | Qt::WindowCloseButtonHint),
      m_fileName(fileName),
      m_newFormWidget(QExtDesignerAbstractNewFormWidget::createNewFormWidget(workbench->core())),
      ...
      m_buttonBox(nullptr)
{
    ...
    connect(m_newFormWidget, &QExtDesignerAbstractNewFormWidget::templateActivated,
            this, &NewForm::slotTemplateActivated);
    connect(m_newFormWidget, &QExtDesignerAbstractNewFormWidget::currentTemplateChanged,
...
QImage NewForm::grabForm(QExtDesignerAbstractFormEditor *core,
                         QIODevice &file,
