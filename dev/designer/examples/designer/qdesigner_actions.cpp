      ...
      m_appFontAction(new QAction(tr("Additional Fonts..."), this))
{
    ...
    m_previewFormAction = ifwm->action(QExtDesignerAbstractFormWindowManager::DefaultPreviewAction);
    m_styleActions = ifwm->actionGroup(QExtDesignerAbstractFormWindowManager::StyledPreviewActionGroup);
    connect(ifwm, &QExtDesignerAbstractFormWindowManager::formWindowSettingsChanged,
    ...
    QExtDesignerAbstractFormWindowManager *formWindowManager = m_core->formWindowManager();
...
// edit actions
//
    QAction *undoAction = formWindowManager->action(QExtDesignerAbstractFormWindowManager::UndoAction);
    undoAction->setObjectName(QStringLiteral("__qt_undo_action"));
    undoAction->setShortcut(QKeySequence::Undo);
    m_editActions->addAction(undoAction);

    QAction *redoAction = formWindowManager->action(QExtDesignerAbstractFormWindowManager::RedoAction);
    ...
    m_editActions->addAction(formWindowManager->action(QExtDesignerAbstractFormWindowManager::CutAction));
    m_editActions->addAction(formWindowManager->action(QExtDesignerAbstractFormWindowManager::CopyAction));
    m_editActions->addAction(formWindowManager->action(QExtDesignerAbstractFormWindowManager::PasteAction));
#endif
    m_editActions->addAction(formWindowManager->action(QExtDesignerAbstractFormWindowManager::DeleteAction));

    m_editActions->addAction(formWindowManager->action(QExtDesignerAbstractFormWindowManager::SelectAllAction));

    m_editActions->addAction(createSeparator(this));

    m_editActions->addAction(formWindowManager->action(QExtDesignerAbstractFormWindowManager::LowerAction));
    m_editActions->addAction(formWindowManager->action(QExtDesignerAbstractFormWindowManager::RaiseAction));

    formWindowManager->action(QExtDesignerAbstractFormWindowManager::LowerAction)->setProperty(QDesignerActions::defaultToolbarPropertyName, true);
    formWindowManager->action(QExtDesignerAbstractFormWindowManager::RaiseAction)->setProperty(QDesignerActions::defaultToolbarPropertyName, true);
...
//
    ...
    for (QObject *plugin : builtinPlugins) {
        if (QExtDesignerFormEditorPluginInterface *formEditorPlugin = qobject_cast<QExtDesignerFormEditorPluginInterface*>(plugin)) {
...
//
    ...
    m_formActions->addAction(formWindowManager->action(QExtDesignerAbstractFormWindowManager::HorizontalLayoutAction));
    m_formActions->addAction(formWindowManager->action(QExtDesignerAbstractFormWindowManager::VerticalLayoutAction));
    m_formActions->addAction(formWindowManager->action(QExtDesignerAbstractFormWindowManager::SplitHorizontalAction));
    m_formActions->addAction(formWindowManager->action(QExtDesignerAbstractFormWindowManager::SplitVerticalAction));
    m_formActions->addAction(formWindowManager->action(QExtDesignerAbstractFormWindowManager::GridLayoutAction));
    m_formActions->addAction(formWindowManager->action(QExtDesignerAbstractFormWindowManager::FormLayoutAction));
    m_formActions->addAction(formWindowManager->action(QExtDesignerAbstractFormWindowManager::BreakLayoutAction));
    m_formActions->addAction(formWindowManager->action(QExtDesignerAbstractFormWindowManager::AdjustSizeAction));
    m_formActions->addAction(formWindowManager->action(QExtDesignerAbstractFormWindowManager::SimplifyLayoutAction));
    m_formActions->addAction(createSeparator(this));

    formWindowManager->action(QExtDesignerAbstractFormWindowManager::HorizontalLayoutAction)->setProperty(QDesignerActions::defaultToolbarPropertyName, true);
    formWindowManager->action(QExtDesignerAbstractFormWindowManager::VerticalLayoutAction)->setProperty(QDesignerActions::defaultToolbarPropertyName, true);
    formWindowManager->action(QExtDesignerAbstractFormWindowManager::SplitHorizontalAction)->setProperty(QDesignerActions::defaultToolbarPropertyName, true);
    formWindowManager->action(QExtDesignerAbstractFormWindowManager::SplitVerticalAction)->setProperty(QDesignerActions::defaultToolbarPropertyName, true);
    formWindowManager->action(QExtDesignerAbstractFormWindowManager::GridLayoutAction)->setProperty(QDesignerActions::defaultToolbarPropertyName, true);
    formWindowManager->action(QExtDesignerAbstractFormWindowManager::FormLayoutAction)->setProperty(QDesignerActions::defaultToolbarPropertyName, true);
    formWindowManager->action(QExtDesignerAbstractFormWindowManager::BreakLayoutAction)->setProperty(QDesignerActions::defaultToolbarPropertyName, true);
    formWindowManager->action(QExtDesignerAbstractFormWindowManager::AdjustSizeAction)->setProperty(QDesignerActions::defaultToolbarPropertyName, true);
    ...
    if (qt_extension<QExtDesignerLanguageExtension *>(m_core->extensionManager(), m_core) == nullptr) {
    ...
    m_formActions->addAction(ifwm->action(QExtDesignerAbstractFormWindowManager::FormWindowSettingsDialogAction));
//
// window actions
//
...
//
    ...
    connect(formWindowManager, &QExtDesignerAbstractFormWindowManager::formWindowAdded,
            this, &QDesignerActions::formWindowCountChanged);
    connect(formWindowManager, &QExtDesignerAbstractFormWindowManager::formWindowRemoved,
            this, &QDesignerActions::formWindowCountChanged);
...
QActionGroup *QDesignerActions::createHelpActions()
{
    ...
    connect(aboutPluginsAction, &QAction::triggered,
            m_core->formWindowManager(), &QExtDesignerAbstractFormWindowManager::showPluginDialog);
...
QExtDesignerAbstractFormEditor *QDesignerActions::core() const
{ return m_core; }
...
{
    QExtDesignerAbstractFormWindowManager *formWindowManager = core()->formWindowManager();
    for (int i=0; i<formWindowManager->formWindowCount(); ++i) {
        QExtDesignerAbstractFormWindow *formWindow = formWindowManager->formWindow(i);
...
bool QDesignerActions::saveFormAs(QExtDesignerAbstractFormWindow *fw)
{
    const QString extension = uiExtension();
...
{
    if (QExtDesignerAbstractFormWindow *fw = core()->formWindowManager()->activeFormWindow()) {
        if (saveForm(fw))
...
void QDesignerActions::saveAllForms()
{
    ...
    if (const int totalWindows = formWindowManager->formWindowCount()) {
        ...
        for (int i = 0; i < totalWindows; ++i) {
            QExtDesignerAbstractFormWindow *fw = formWindowManager->formWindow(i);
            if (fw && fw->isDirty()) {
...
bool QDesignerActions::saveForm(QExtDesignerAbstractFormWindow *fw)
{
    bool ret;
...
{
    QExtDesignerAbstractFormWindow *fw = core()->formWindowManager()->activeFormWindow();
    if (!fw)
        return;
...
bool QDesignerActions::readInForm(const QString &fileName)
{
    ...
    for (int i = 0; i < totalWindows; ++i) {
        QExtDesignerAbstractFormWindow *w = formWindowManager->formWindow(i);
        if (w->fileName() == fn) {
            w->raise();
...
bool QDesignerActions::writeOutForm(QExtDesignerAbstractFormWindow *fw, const QString &saveFile, bool check)
{
...
void QDesignerActions::activeFormWindowChanged(QExtDesignerAbstractFormWindow *formWindow)
{
...
void QDesignerActions::formWindowSettingsChanged(QExtDesignerAbstractFormWindow *fw)
{
...
void QDesignerActions::backupForms()
{
    ...
    for (int i = 0; i < count; ++i) {
        ...
        QExtDesignerAbstractFormWindow *fwi = fw->editor();
...
QString QDesignerActions::fixResourceFileBackupPath(QExtDesignerAbstractFormWindow *fwi, const QDir& backupDir)
{
...
QPixmap QDesignerActions::createPreviewPixmap(QExtDesignerAbstractFormWindow *fw)
{
