...
public:
    ...
    bool writeOutForm(QExtDesignerAbstractFormWindow *formWindow, const QString &fileName) const;
    bool saveForm(QExtDesignerAbstractFormWindow *fw);
    bool handleClose();
    bool readInBackup();
    void updateBackup(QExtDesignerAbstractFormWindow* fwi);
...
private slots:
    ...
    void updateWindowMenu(QExtDesignerAbstractFormWindow *fw);
    void formWindowActionTriggered(QAction *a);
    void adjustMDIFormPositions();
    void minimizationStateChanged(QExtDesignerAbstractFormWindow *formWindow, bool minimized);
...
private:
    ...
    QExtDesignerIntegration *m_integration;
