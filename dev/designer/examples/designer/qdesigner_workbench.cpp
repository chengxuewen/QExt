    ...
    m_globalMenuBar(new QMenuBar)
{
    ...
    // Integration
    m_integration = new QExtDesignerIntegration(m_core, this);
    connect(m_integration, &QExtDesignerIntegration::helpRequested,
    ...
    connect(m_core->formWindowManager(), &QExtDesignerAbstractFormWindowManager::activeFormWindowChanged,
...
QExtDesignerAbstractFormWindowManager *QDesignerWorkbench::formWindowManager() const
{
    return m_core->formWindowManager();
}

QExtDesignerAbstractFormEditor *QDesignerWorkbench::core() const
{
    return m_core;
}
...
{
    QExtDesignerAbstractFormWindow *editor = formWindow->editor();
...
bool QDesignerWorkbench::writeOutForm(QExtDesignerAbstractFormWindow *formWindow, const QString &fileName) const
{
    return m_actionManager->writeOutForm(formWindow, fileName);
}

bool QDesignerWorkbench::saveForm(QExtDesignerAbstractFormWindow *frm)
{
...
void QDesignerWorkbench::updateWindowMenu(QExtDesignerAbstractFormWindow *fwi)
{
...
void QDesignerWorkbench::updateBackup(QExtDesignerAbstractFormWindow* fwi)
{
...
void QDesignerWorkbench::minimizationStateChanged(QExtDesignerAbstractFormWindow *formWindow, bool minimized)
{
...
{
    QExtDesignerAbstractFormWindow *fwi = core()->formWindowManager()->activeFormWindow();
