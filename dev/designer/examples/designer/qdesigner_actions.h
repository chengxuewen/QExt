...
public:
    ...
    bool writeOutForm(QExtDesignerAbstractFormWindow *formWindow, const QString &fileName, bool check = true);
...
private:
    ...
    bool saveFormAs(QExtDesignerAbstractFormWindow *fw);
    void updateRecentFileActions();
    void addRecentFile(const QString &fileName);
    void showHelp(const QString &help);
    void closePreview();
    QRect fixDialogRect(const QRect &rect) const;
    QString fixResourceFileBackupPath(QExtDesignerAbstractFormWindow *fwi, const QDir& backupDir);
    void showStatusBarMessage(const QString &message) const;
    QActionGroup *createHelpActions();
    bool ensureBackupDirectories();
    QPixmap createPreviewPixmap(QExtDesignerAbstractFormWindow *fw);
