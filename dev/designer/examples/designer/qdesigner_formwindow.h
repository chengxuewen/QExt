...
class QDesignerFormWindow: public QWidget
{
    Q_OBJECT
public:
    QDesignerFormWindow(QExtDesignerAbstractFormWindow *formWindow, QDesignerWorkbench *workbench,
    ...
    QExtDesignerAbstractFormWindow *editor() const;
...
private:
    ...
    QPointer<QExtDesignerAbstractFormWindow> m_editor;
