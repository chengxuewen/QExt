...
PreferencesDialog::PreferencesDialog(QExtDesignerAbstractFormEditor *core, QWidget *parentWidget) :
    ...
    m_core(core)
{
    ...
    for (QExtDesignerOptionsPageInterface *optionsPage : qAsConst(m_optionsPages)) {
