...
static inline QWidget *createPropertyEditor(QExtDesignerAbstractFormEditor *core, QWidget *parent = nullptr)
{
    QExtDesignerAbstractPropertyEditor *widget = QDesignerComponents::createPropertyEditor(core, parent);
...
{
    if (QExtDesignerAbstractPropertyEditor *e = workbench()->core()->propertyEditor()) {
...
static inline QWidget *createActionEditor(QExtDesignerAbstractFormEditor *core, QWidget *parent = nullptr)
{
    QExtDesignerAbstractActionEditor *widget = QDesignerComponents::createActionEditor(core, parent);
...
static inline QWidget *createObjectInspector(QExtDesignerAbstractFormEditor *core, QWidget *parent = nullptr)
{
    QExtDesignerAbstractObjectInspector *widget = QDesignerComponents::createObjectInspector(core, parent);
...
static inline QWidget *createWidgetBox(QExtDesignerAbstractFormEditor *core, QWidget *parent = nullptr)
{
    QExtDesignerAbstractWidgetBox *widget = QDesignerComponents::createWidgetBox(core, parent);
