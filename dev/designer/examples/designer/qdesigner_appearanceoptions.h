...
class QDesignerAppearanceOptionsPage : public QObject, public QExtDesignerOptionsPageInterface
{
    Q_OBJECT

public:
    QDesignerAppearanceOptionsPage(QExtDesignerAbstractFormEditor *core);
