...
public:
    ...
    void save(QExtDesignerSettingsInterface *s, const QString &prefix) const;
    void restore(const QExtDesignerSettingsInterface *s, const QString &prefix);
...
void AppFontManager::save(QExtDesignerSettingsInterface *s, const QString &prefix) const
{
...
void AppFontManager::restore(const QExtDesignerSettingsInterface *s, const QString &prefix)
{
    QString key = prefix;
    key += QLatin1Char('/');
...
void AppFontWidget::save(QExtDesignerSettingsInterface *s, const QString &prefix)
{
    AppFontManager::instance().save(s, prefix);
}

void AppFontWidget::restore(const QExtDesignerSettingsInterface *s, const QString &prefix)
{
