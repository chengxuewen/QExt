...
class QEXT_DESIGNER_API CETypes
{
public:
...
class QEXT_DESIGNER_API Connection : public CETypes
{
public:
...
class QEXT_DESIGNER_API ConnectionEdit : public QWidget, public CETypes
{
    Q_OBJECT
public:
...
class QEXT_DESIGNER_API CECommand : public QUndoCommand, public CETypes
{
public:
...
class QEXT_DESIGNER_API AddConnectionCommand : public CECommand
{
public:
...
class QEXT_DESIGNER_API DeleteConnectionsCommand : public CECommand
{
public:
