...
class QEXT_DESIGNER_API LanguageResourceDialog : public QDialog
{
    Q_OBJECT
...
class QEXT_DESIGNER_API IconSelector: public QWidget
{
    Q_OBJECT
public:
...
class QEXT_DESIGNER_API IconThemeEditor : public QWidget
{
    Q_OBJECT
