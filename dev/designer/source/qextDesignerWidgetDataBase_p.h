...
class QEXT_DESIGNER_API WidgetDataBaseItem: public QExtDesignerWidgetDataBaseItemInterface
{
public:
...
QEXT_DESIGNER_API IncludeSpecification  includeSpecification(QString includeFile);
QEXT_DESIGNER_API QString buildIncludeFile(QString includeFile, IncludeType includeType);

class QEXT_DESIGNER_API WidgetDataBase: public QDesignerWidgetDataBaseInterface
{
    Q_OBJECT
public:
...
QEXT_DESIGNER_API QExtDesignerWidgetDataBaseItemInterface
...
QEXT_DESIGNER_API WidgetDataBaseItemList
