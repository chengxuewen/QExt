...
class QEXT_DESIGNER_API QDesignerWidget : public QWidget
{
    Q_OBJECT
public:
...
class QEXT_DESIGNER_API QDesignerDialog : public QDialog
{
    Q_OBJECT
public:
...
class QEXT_DESIGNER_API Line : public QFrame
{
    Q_OBJECT
