...
class QEXT_DESIGNER_API QDesignerPropertySheet: public QObject, public QExtDesignerPropertySheetExtension, public QExtDesignerDynamicPropertySheetExtension
{
    Q_OBJECT
...
class QEXT_DESIGNER_API QDesignerAbstractPropertySheetFactory: public QExtensionFactory
{
    Q_OBJECT
