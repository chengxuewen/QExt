...
QEXT_DESIGNER_API bool isPromoted(QExtDesignerAbstractFormEditor *core, QWidget* widget)
{
...
QEXT_DESIGNER_API QString promotedCustomClassName(QExtDesignerAbstractFormEditor *core, QWidget* widget)
{
    const MetaDataBase *db = qobject_cast<const MetaDataBase *>(core->metaDataBase());
    if (!db)
        return QString();
...
QEXT_DESIGNER_API QString promotedExtends(QExtDesignerAbstractFormEditor *core, QWidget* widget)
{
