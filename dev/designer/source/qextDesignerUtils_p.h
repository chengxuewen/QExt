...
QEXT_DESIGNER_API void designerWarning(const QString &message);

QEXT_DESIGNER_API void reloadIconResources(DesignerIconCache *iconCache, QObject *object);
...
class QEXT_DESIGNER_API DesignerMetaEnum : public MetaEnum<int>
{
public:
...
class QEXT_DESIGNER_API DesignerMetaFlags : public MetaEnum<uint>
{
public:
...
struct QEXT_DESIGNER_API PropertySheetEnumValue
{
...
struct QEXT_DESIGNER_API PropertySheetFlagValue
{
...
class QEXT_DESIGNER_API PropertySheetPixmapValue
{
public:
...
class QEXT_DESIGNER_API PropertySheetIconValue
{
 public:
...
QEXT_DESIGNER_API QDebug operator<<(QDebug, const PropertySheetIconValue &);

class QEXT_DESIGNER_API DesignerPixmapCache : public QObject
{
    Q_OBJECT
public:
...
class QEXT_DESIGNER_API DesignerIconCache : public QObject
{
    Q_OBJECT
public:
...
class QEXT_DESIGNER_API PropertySheetTranslatableData
{
protected:
...
class QEXT_DESIGNER_API PropertySheetStringValue : public PropertySheetTranslatableData
{
public:
...
class QEXT_DESIGNER_API PropertySheetStringListValue : public PropertySheetTranslatableData
{
public:
...
// -------------- StringValue: Returned by the property sheet for strings
class QEXT_DESIGNER_API PropertySheetKeySequenceValue : public PropertySheetTranslatableData
{
public:
...
QEXT_DESIGNER_API QDesignerFormWindowCommand *createTextPropertyCommand(const QString &propertyName, const QString &text, QObject *object, QExtDesignerAbstractFormWindow *fw);

// Returns preferred task menu action for managed widget
QEXT_DESIGNER_API QAction *preferredEditAction(QExtDesignerAbstractFormEditor *core, QWidget *managedWidget);
...
QEXT_DESIGNER_API bool runUIC(const QString &fileName, UicLanguage language,
                                    QByteArray& ba, QString &errorMessage);

// Find a suitable variable name for a class.
QEXT_DESIGNER_API QString qtify(const QString &name);
...
class QEXT_DESIGNER_API UpdateBlocker {
