...
struct QEXT_DESIGNER_API LayoutProperties
{
    LayoutProperties();
    void clear();
...
class QEXT_DESIGNER_API QLayoutSupport: public QObject, public QExtDesignerLayoutDecorationExtension
{
    Q_OBJECT
...
// Red layout widget.
class QEXT_DESIGNER_API QLayoutWidget: public QWidget
{
    Q_OBJECT
public:
