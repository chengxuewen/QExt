...
#include <qextDesignerDeviceSkin.h>
...
QEXT_DESIGNER_API bool operator<(const PreviewConfiguration &pc1, const PreviewConfiguration &pc2)
{
...
#include "qextDesignerPreviewManager.moc"
