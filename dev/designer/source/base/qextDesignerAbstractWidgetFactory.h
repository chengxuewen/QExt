...
#ifndef _QEXTABSTRACTWIDGETFACTORY_H
#define _QEXTABSTRACTWIDGETFACTORY_H
...
class QEXT_DESIGNER_API QExtDesignerAbstractWidgetFactory: public QObject
{
    Q_OBJECT
public:
    explicit QExtDesignerAbstractWidgetFactory(QObject *parent = nullptr);
    virtual ~QExtDesignerAbstractWidgetFactory();
...
#endif // _QEXTABSTRACTWIDGETFACTORY_H
