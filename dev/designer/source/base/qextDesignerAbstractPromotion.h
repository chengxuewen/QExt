...
#ifndef _QEXTDESIGNERABSTRACTPROMOTIONINTERFACE_H
#define _QEXTDESIGNERABSTRACTPROMOTIONINTERFACE_H
...
class QEXT_DESIGNER_API QExtDesignerPromotionInterface
{
public:
    virtual ~QExtDesignerPromotionInterface();

    struct PromotedClass {
        QExtDesignerWidgetDataBaseItemInterface *baseItem;
        QExtDesignerWidgetDataBaseItemInterface *promotedItem;
    };
    ...
    virtual QList<QExtDesignerWidgetDataBaseItemInterface *> promotionBaseClasses() const = 0;
};

QT_END_NAMESPACE

#endif // _QEXTDESIGNERABSTRACTPROMOTIONINTERFACE_H
