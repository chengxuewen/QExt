...
#ifndef _QEXTDESIGNERABSTRACTFORMWINDOWCURSOR_H
#define _QEXTDESIGNERABSTRACTFORMWINDOWCURSOR_H
...
class QEXT_DESIGNER_API QExtDesignerFormWindowCursorInterface
{
public:
    enum MoveOperation
    {
...
public:
    virtual ~QExtDesignerFormWindowCursorInterface() {}
...
#endif // _QEXTDESIGNERABSTRACTFORMWINDOWCURSOR_H
