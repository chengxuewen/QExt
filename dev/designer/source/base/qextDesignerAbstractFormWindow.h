...
class QEXT_DESIGNER_API QExtDesignerAbstractFormWindow: public QWidget
{
    Q_OBJECT
public:
    enum FeatureFlag
...
public:
    explicit QExtDesignerAbstractFormWindow(QWidget *parent = nullptr, Qt::WindowFlags flags = Qt::WindowFlags());
    virtual ~QExtDesignerAbstractFormWindow();
    ...
    virtual QExtDesignerFormWindowCursorInterface *cursor() const = 0;
    ...
    virtual QExtDesignerAbstractFormWindowTool *tool(int index) const = 0;
    virtual void registerTool(QExtDesignerAbstractFormWindowTool *tool) = 0;
    ...
    static QExtDesignerAbstractFormWindow *findFormWindow(QWidget *w);
    static QExtDesignerAbstractFormWindow *findFormWindow(QObject *obj);
