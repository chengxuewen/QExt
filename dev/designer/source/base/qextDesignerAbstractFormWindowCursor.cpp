...
/*!
    ...
    \brief The QExtDesignerFormWindowCursorInterface class allows you to
    query and modify a form window's widget selection, and in addition
    modify the properties of all the form's widgets.

    \inmodule QtDesigner

    QExtDesignerFormWindowCursorInterface is a convenience class that
    ...
    windows. QExtDesignerAbstractFormWindow always provides an
    associated cursor interface. The form window for a given widget
    can be retrieved using the static
    QExtDesignerAbstractFormWindow::findFormWindow() functions. For
    example:
    ...
    \QD's \l {QExtDesignerAbstractFormWindowManager}{form window
    manager}.
    ...
    \sa QExtDesignerAbstractFormWindow, QExtDesignerAbstractFormWindowManager
*/

/*!
    \enum QExtDesignerFormWindowCursorInterface::MoveOperation
...
/*!
    \enum QExtDesignerFormWindowCursorInterface::MoveMode
...
/*!
    ...
    returns false.
*/
bool QExtDesignerFormWindowCursorInterface::isWidgetSelected(QWidget *widget) const
{
...
/*!
    \fn virtual QExtDesignerFormWindowCursorInterface::~QExtDesignerFormWindowCursorInterface()

    Destroys the cursor interface.
*/

/*!
    \fn virtual QExtDesignerAbstractFormWindow *QExtDesignerFormWindowCursorInterface::formWindow() const

    Returns the form window interface associated with this cursor interface.
*/

/*!
    \fn virtual bool QExtDesignerFormWindowCursorInterface::movePosition(MoveOperation operation, MoveMode mode)
...
/*!
    \fn virtual int QExtDesignerFormWindowCursorInterface::position() const
...
/*!
    \fn virtual void QExtDesignerFormWindowCursorInterface::setPosition(int position, MoveMode mode = MoveAnchor)
...
/*!
    \fn virtual QWidget *QExtDesignerFormWindowCursorInterface::current() const
...
/*!
    \fn virtual int QExtDesignerFormWindowCursorInterface::widgetCount() const
...
/*!
    \fn virtual QWidget *QExtDesignerFormWindowCursorInterface::widget(int index) const
...
/*!
    \fn virtual bool QExtDesignerFormWindowCursorInterface::hasSelection() const
...
/*!
    \fn virtual int QExtDesignerFormWindowCursorInterface::selectedWidgetCount() const
...
/*!
    \fn virtual QWidget *QExtDesignerFormWindowCursorInterface::selectedWidget(int index) const
...
/*!
    \fn virtual void QExtDesignerFormWindowCursorInterface::setProperty(const QString &name, const QVariant &value)
...
/*!
    \fn virtual void QExtDesignerFormWindowCursorInterface::setWidgetProperty(QWidget *widget, const QString &name, const QVariant &value)
...
/*!
    \fn virtual void QExtDesignerFormWindowCursorInterface::resetWidgetProperty(QWidget *widget, const QString &name)
