...
#ifndef _QEXTDESIGNERABSTRACTWIDGETDATABASE_H
#define _QEXTDESIGNERABSTRACTWIDGETDATABASE_H
...
{
public:
    virtual ~QExtDesignerWidgetDataBaseItemInterface() {}
...
class QEXT_DESIGNER_API QDesignerWidgetDataBaseInterface: public QObject
{
    Q_OBJECT
public:
    ...
    virtual QExtDesignerWidgetDataBaseItemInterface *item(int index) const;

    virtual int indexOf(QExtDesignerWidgetDataBaseItemInterface *item) const;
    virtual void insert(int index, QExtDesignerWidgetDataBaseItemInterface *item);
    virtual void append(QExtDesignerWidgetDataBaseItemInterface *item);
...
protected:
    QList<QExtDesignerWidgetDataBaseItemInterface *> m_items;
};

QT_END_NAMESPACE

#endif // _QEXTDESIGNERABSTRACTWIDGETDATABASE_H
