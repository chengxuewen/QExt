...
#ifndef _QEXTDESIGNERABSTRACTDIALOGGUI_P_H
#define _QEXTDESIGNERABSTRACTDIALOGGUI_P_H
...
class QEXT_DESIGNER_API QExtDesignerAbstractDialogGui
{
    Q_DISABLE_COPY_MOVE(QExtDesignerAbstractDialogGui)
public:
    QExtDesignerAbstractDialogGui();
    virtual ~QExtDesignerAbstractDialogGui();
...
#endif // _QEXTDESIGNERABSTRACTDIALOGGUI_H
