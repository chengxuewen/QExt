...
/*!
    ...
    \brief The QExtDesignerAbstractFormWindow class allows you to query
    and manipulate form windows appearing in Qt Designer's workspace.

    \inmodule QtDesigner

    QExtDesignerAbstractFormWindow provides information about
    ...
    controlled by \QD's \l {QExtDesignerAbstractFormWindowManager}{form
    window manager}.

    If you are looking for the form window containing a specific
    widget, you can use the static
    QExtDesignerAbstractFormWindow::findFormWindow() function:
    ...
    QExtDesignerAbstractFormEditor::formWindowManager() function to
    retrieve an interface to the manager. Once you have this
    interface, you have access to all of \QD's current form windows
    through the QExtDesignerAbstractFormWindowManager::formWindow()
    function. For example:

    \snippet lib/tools_designer_src_lib_sdk_abstractformwindow.cpp 1

    The pointer to \QD's current QExtDesignerAbstractFormEditor object
    ...
    \QD's workspace. But QExtDesignerAbstractFormWindow provides you
    ...
    \sa QExtDesignerFormWindowCursorInterface,
    QExtDesignerAbstractFormEditor, QExtDesignerAbstractFormWindowManager
*/

/*!
    \enum QExtDesignerAbstractFormWindow::FeatureFlag
...
/*!
    \enum QExtDesignerAbstractFormWindow::ResourceFileSaveMode
    \since 5.0
...
*/
QExtDesignerAbstractFormWindow::QExtDesignerAbstractFormWindow(QWidget *parent, Qt::WindowFlags flags)
...
*/
QExtDesignerAbstractFormWindow::~QExtDesignerAbstractFormWindow() = default;

/*!
    Returns a pointer to \QD's current QExtDesignerAbstractFormEditor
    object.
*/
QExtDesignerAbstractFormEditor *QExtDesignerAbstractFormWindow::core() const
{
    return nullptr;
}

/*!
    \fn QExtDesignerAbstractFormWindow *QExtDesignerAbstractFormWindow::findFormWindow(QWidget *widget)
...
QExtDesignerAbstractFormWindow *QExtDesignerAbstractFormWindow::findFormWindow(QWidget *w)
{
    while (w != nullptr) {
        if (QExtDesignerAbstractFormWindow *fw = qobject_cast<QExtDesignerAbstractFormWindow*>(w))
            return fw;
...
/*!
    \fn QExtDesignerAbstractFormWindow *QExtDesignerAbstractFormWindow::findFormWindow(QObject *object)
...
QExtDesignerAbstractFormWindow *QExtDesignerAbstractFormWindow::findFormWindow(QObject *object)
{
    while (object != nullptr) {
        if (QExtDesignerAbstractFormWindow *fw = qobject_cast<QExtDesignerAbstractFormWindow*>(object))
            return fw;
...
/*!
    \fn virtual QtResourceSet *QExtDesignerAbstractFormWindow::resourceSet() const
...
/*!
    \fn virtual void QExtDesignerAbstractFormWindow::setResourceSet(QtResourceSet *resourceSet)
...
QStringList QExtDesignerAbstractFormWindow::activeResourceFilePaths() const
{
...
void QExtDesignerAbstractFormWindow::activateResourceFilePaths(const QStringList &paths, int *errorCount, QString *errorMessages)
{
    resourceSet()->activateResourceFilePaths(paths, errorCount, errorMessages);
}

/*!
    \fn virtual QString QExtDesignerAbstractFormWindow::fileName() const
...
/*!
    \fn virtual QDir QExtDesignerAbstractFormWindow::absoluteDir() const
...
/*!
    \fn virtual QString QExtDesignerAbstractFormWindow::contents() const
...
/*!
    \fn virtual QStringList QExtDesignerAbstractFormWindow::checkContents() const
...
/*!
    \fn virtual bool QExtDesignerAbstractFormWindow::setContents(QIODevice *device, QString *errorMessage = 0)
...
/*!
    \fn virtual Feature QExtDesignerAbstractFormWindow::features() const
...
/*!
    \fn virtual bool QExtDesignerAbstractFormWindow::hasFeature(Feature feature) const
...
/*!
    \fn virtual QString QExtDesignerAbstractFormWindow::author() const
...
/*!
    \fn virtual void QExtDesignerAbstractFormWindow::setAuthor(const QString &author)
...
/*!
    \fn virtual QString QExtDesignerAbstractFormWindow::comment() const

    Returns comments about the form currently being displayed in the window.
*/

/*!
    \fn virtual void QExtDesignerAbstractFormWindow::setComment(const QString &comment)
...
/*!
    \fn virtual void QExtDesignerAbstractFormWindow::layoutDefault(int *margin, int *spacing)
...
/*!
    \fn virtual void QExtDesignerAbstractFormWindow::setLayoutDefault(int margin, int spacing)
...
/*!
    \fn virtual void QExtDesignerAbstractFormWindow::layoutFunction(QString *margin, QString *spacing)
...
/*!
    \fn virtual void QExtDesignerAbstractFormWindow::setLayoutFunction(const QString &margin, const QString &spacing)
...
/*!
    \fn virtual QString QExtDesignerAbstractFormWindow::pixmapFunction() const
...
/*!
    \fn virtual void QExtDesignerAbstractFormWindow::setPixmapFunction(const QString &pixmapFunction)
...
/*!
    \fn virtual QString QExtDesignerAbstractFormWindow::exportMacro() const
...
/*!
    \fn virtual void QExtDesignerAbstractFormWindow::setExportMacro(const QString &exportMacro)
...
/*!
    \fn virtual QStringList QExtDesignerAbstractFormWindow::includeHints() const
...
/*!
    \fn virtual void QExtDesignerAbstractFormWindow::setIncludeHints(const QStringList &includeHints)
...
/*!
    \fn virtual QExtDesignerFormWindowCursorInterface *QExtDesignerAbstractFormWindow::cursor() const

    Returns the cursor interface used by the form window.
*/

/*!
    \fn virtual int QExtDesignerAbstractFormWindow::toolCount() const
...
/*!
    \fn virtual int QExtDesignerAbstractFormWindow::currentTool() const
...
/*!
    \fn virtual void QExtDesignerAbstractFormWindow::setCurrentTool(int index)
...
/*!
    \fn virtual QExtDesignerAbstractFormWindowTool *QExtDesignerAbstractFormWindow::tool(int index) const
...
/*!
    \fn virtual void QExtDesignerAbstractFormWindow::registerTool(QExtDesignerAbstractFormWindowTool *tool)
...
/*!
    \fn virtual QPoint QExtDesignerAbstractFormWindow::grid() const = 0
...
/*!
    \fn virtual QWidget *QExtDesignerAbstractFormWindow::mainContainer() const
...
/*!
    \fn virtual QWidget *QExtDesignerAbstractFormWindow::formContainer() const
...
/*!
    \fn virtual void QExtDesignerAbstractFormWindow::setMainContainer(QWidget *mainContainer)
...
/*!
    \fn virtual bool QExtDesignerAbstractFormWindow::isManaged(QWidget *widget) const
...
/*!
    \fn virtual bool QExtDesignerAbstractFormWindow::isDirty() const
...
/*!
    \fn virtual QUndoStack *QExtDesignerAbstractFormWindow::commandHistory() const
...
/*!
    \fn virtual void QExtDesignerAbstractFormWindow::beginCommand(const QString &description)
...
/*!
    \fn virtual void QExtDesignerAbstractFormWindow::endCommand()
...
/*!
    \fn virtual void QExtDesignerAbstractFormWindow::simplifySelection(QList<QWidget*> *widgets) const
...
/*!
    \fn virtual void QExtDesignerAbstractFormWindow::emitSelectionChanged()
...
/*!
    \fn virtual QStringList QExtDesignerAbstractFormWindow::resourceFiles() const
...
/*!
    \fn virtual void QExtDesignerAbstractFormWindow::addResourceFile(const QString &path)
...
/*!
    \fn virtual void QExtDesignerAbstractFormWindow::removeResourceFile(const QString &path)
...
/*!
    \fn virtual void QExtDesignerAbstractFormWindow::ensureUniqueObjectName(QObject *object)
...
/*!
    \fn virtual void QExtDesignerAbstractFormWindow::manageWidget(QWidget *widget)
...
/*!
    \fn virtual void QExtDesignerAbstractFormWindow::unmanageWidget(QWidget *widget)
...
/*!
    \fn virtual void QExtDesignerAbstractFormWindow::setFeatures(Feature features)
...
/*!
    \fn virtual void QExtDesignerAbstractFormWindow::setDirty(bool dirty)
...
/*!
\fn virtual void QExtDesignerAbstractFormWindow::clearSelection(bool update)
...
/*!
    \fn virtual void QExtDesignerAbstractFormWindow::selectWidget(QWidget *widget, bool select)
...
/*!
    \fn virtual void QExtDesignerAbstractFormWindow::setGrid(const QPoint &grid)
...
/*!
    \fn virtual void QExtDesignerAbstractFormWindow::setFileName(const QString &fileName)
...
/*!
    \fn virtual bool QExtDesignerAbstractFormWindow::setContents(const QString &contents)
...
/*!
    \fn virtual void QExtDesignerAbstractFormWindow::editWidgets()
...
/*!
    \fn void QExtDesignerAbstractFormWindow::mainContainerChanged(QWidget *mainContainer)
...
/*!
    \fn void QExtDesignerAbstractFormWindow::toolChanged(int toolIndex)
...
/*!
    \fn void QExtDesignerAbstractFormWindow::fileNameChanged(const QString &fileName)
...
/*!
    \fn void QExtDesignerAbstractFormWindow::featureChanged(Feature feature)
...
/*!
    \fn void QExtDesignerAbstractFormWindow::selectionChanged()
...
/*!
    \fn void QExtDesignerAbstractFormWindow::geometryChanged()

    This signal is emitted whenever the form's geometry changes.
*/

/*!
    \fn void QExtDesignerAbstractFormWindow::resourceFilesChanged()
...
/*!
    \fn ResourceFileSaveMode QExtDesignerAbstractFormWindow::resourceFileSaveMode() const
...
/*!
    \fn void QExtDesignerAbstractFormWindow::setResourceFileSaveMode(ResourceFileSaveMode behavior)
...
/*!
    \fn void QExtDesignerAbstractFormWindow::widgetManaged(QWidget *widget)
...
/*!
    \fn void QExtDesignerAbstractFormWindow::widgetUnmanaged(QWidget *widget)
...
/*!
    \fn void QExtDesignerAbstractFormWindow::aboutToUnmanageWidget(QWidget *widget)
...
/*!
    \fn void QExtDesignerAbstractFormWindow::activated(QWidget *widget)
...
/*!
    \fn void QExtDesignerAbstractFormWindow::changed()

    This signal is emitted whenever a form is changed.
*/

/*!
    \fn void QExtDesignerAbstractFormWindow::widgetRemoved(QWidget *widget)
...
/*!
    \fn void QExtDesignerAbstractFormWindow::objectRemoved(QObject *object)
