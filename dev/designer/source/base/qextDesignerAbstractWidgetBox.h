...
#ifndef _QEXTDESIGNERABSTRACTWIDGETBOX_H
#define _QEXTDESIGNERABSTRACTWIDGETBOX_H
...
class QEXT_DESIGNER_API QExtDesignerAbstractWidgetBox : public QWidget
{
    Q_OBJECT
public:
    class QEXT_DESIGNER_API Widget {
    public:
    ...
    explicit QExtDesignerAbstractWidgetBox(QWidget *parent = nullptr, Qt::WindowFlags flags = Qt::WindowFlags());
    virtual ~QExtDesignerAbstractWidgetBox();
    ...
    virtual void dropWidgets(const QList<QExtDesignerDnDItemInterface*> &item_list,
...
Q_DECLARE_METATYPE(QT_PREPEND_NAMESPACE(QExtDesignerAbstractWidgetBox::Widget))

#endif // _QEXTDESIGNERABSTRACTWIDGETBOX_H
