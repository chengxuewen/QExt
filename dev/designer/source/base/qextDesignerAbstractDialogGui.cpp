...
/*!
    ...
    \brief The QExtDesignerAbstractDialogGui allows integrations of \QD to replace the
           message boxes displayed by \QD by custom dialogs.

    \inmodule QtDesigner

    QExtDesignerAbstractDialogGui provides virtual functions that can be overwritten
    to display message boxes and file dialogs.
    \sa QMessageBox, QFileDialog
*/

/*!
    \enum QExtDesignerAbstractDialogGui::Message
...
/*!
    Constructs a QExtDesignerAbstractDialogGui object.
*/

QExtDesignerAbstractDialogGui::QExtDesignerAbstractDialogGui() = default;

/*!
    Destroys the QExtDesignerAbstractDialogGui object.
*/
QExtDesignerAbstractDialogGui::~QExtDesignerAbstractDialogGui() = default;

/*!
    \fn QMessageBox::StandardButton QExtDesignerAbstractDialogGui::message(QWidget *parent, Message context, QMessageBox::Icon icon, const QString &title, const QString &text, QMessageBox::StandardButtons buttons, QMessageBox::StandardButton defaultButton)
...
/*!
    \fn QString QExtDesignerAbstractDialogGui::getExistingDirectory(QWidget *parent, const QString &caption, const QString &dir, QFileDialog::Options options)
...
/*!
    \fn QString QExtDesignerAbstractDialogGui::getOpenFileName(QWidget *parent, const QString &caption, const QString &dir, const QString &filter, QString *selectedFilter, QFileDialog::Options)
...
/*!
    \fn QStringList QExtDesignerAbstractDialogGui::getOpenFileNames(QWidget *parent, const QString &caption, const QString &dir, const QString &filter, QString *selectedFilter, QFileDialog::Options)
...
QString QExtDesignerAbstractDialogGui::getOpenImageFileName(QWidget *parent, const QString &caption, const QString &dir, const QString &filter, QString *selectedFilter, QFileDialog::Options options)
{
...
QStringList QExtDesignerAbstractDialogGui::getOpenImageFileNames(QWidget *parent, const QString &caption, const QString &dir, const QString &filter, QString *selectedFilter, QFileDialog::Options options)
{
    return getOpenFileNames(parent, caption, dir, filter, selectedFilter, options);
}

/*!
    \fn QString QExtDesignerAbstractDialogGui::getSaveFileName(QWidget *parent, const QString &caption, const QString &dir, const QString &filter, QString *selectedFilter, QFileDialog::Options)
