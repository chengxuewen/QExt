...
/*!
    ...
    \brief The QExtDesignerAbstractPropertyEditor class allows you to
    query and manipulate the current state of Qt Designer's property
    editor.

    \inmodule QtDesigner

    QExtDesignerAbstractPropertyEditor contains a collection of
    ...
    The QExtDesignerAbstractPropertyEditor class is not intended to be
    instantiated directly. You can retrieve an interface to \QD's
    property editor using the
    QExtDesignerAbstractFormEditor::propertyEditor() function. A pointer
    to \QD's current QExtDesignerAbstractFormEditor object (\c
...
*/
QExtDesignerAbstractPropertyEditor::QExtDesignerAbstractPropertyEditor(QWidget *parent, Qt::WindowFlags flags)
...
*/
QExtDesignerAbstractPropertyEditor::~QExtDesignerAbstractPropertyEditor() = default;

/*!
    Returns a pointer to \QD's current QExtDesignerAbstractFormEditor
    object.
*/
QExtDesignerAbstractFormEditor *QExtDesignerAbstractPropertyEditor::core() const
{
    return nullptr;
}

/*!
    \fn bool QExtDesignerAbstractPropertyEditor::isReadOnly() const
...
/*!
    \fn QObject *QExtDesignerAbstractPropertyEditor::object() const
...
/*!
    \fn QString QExtDesignerAbstractPropertyEditor::currentPropertyName() const
...
/*!
    \fn void QExtDesignerAbstractPropertyEditor::propertyChanged(const QString &name, const QVariant &value)
...
/*!
    \fn void QExtDesignerAbstractPropertyEditor::setObject(QObject *object)
...
/*!
    \fn void QExtDesignerAbstractPropertyEditor::setPropertyValue(const QString &name, const QVariant &value, bool changed = true)
...
/*!
    \fn void QExtDesignerAbstractPropertyEditor::setReadOnly(bool readOnly)
