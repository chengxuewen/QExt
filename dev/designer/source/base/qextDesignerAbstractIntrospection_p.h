...
#ifndef _QEXTDESIGNERABSTRACTMETAOBJECT_P_H
#define _QEXTDESIGNERABSTRACTMETAOBJECT_P_H
...
class QEXT_DESIGNER_API QExtDesignerMetaEnumInterface
{
public:
    QExtDesignerMetaEnumInterface();
    virtual ~QExtDesignerMetaEnumInterface();
...
class QEXT_DESIGNER_API QExtDesignerMetaPropertyInterface
{
public:
    ...
    QExtDesignerMetaPropertyInterface();
    virtual ~QExtDesignerMetaPropertyInterface();

    virtual const QExtDesignerMetaEnumInterface *enumerator() const = 0;
...
Q_DECLARE_OPERATORS_FOR_FLAGS(QExtDesignerMetaPropertyInterface::AccessFlags)
Q_DECLARE_OPERATORS_FOR_FLAGS(QExtDesignerMetaPropertyInterface::Attributes)

class QEXT_DESIGNER_API QExtDesignerMetaMethodInterface
{
public:
    QExtDesignerMetaMethodInterface();
    virtual ~QExtDesignerMetaMethodInterface();
...
class QEXT_DESIGNER_API QExtDesignerMetaObjectInterface {
public:
    QExtDesignerMetaObjectInterface();
    virtual ~QExtDesignerMetaObjectInterface();

    virtual QString className() const = 0;
    virtual const QExtDesignerMetaEnumInterface *enumerator(int index) const = 0;
    ...
    virtual const QExtDesignerMetaMethodInterface *method(int index) const = 0;
    virtual int methodCount() const = 0;
    virtual int methodOffset() const = 0;

    virtual const  QExtDesignerMetaPropertyInterface *property(int index) const = 0;
    virtual int propertyCount() const = 0;
    virtual int propertyOffset() const = 0;

    virtual const QExtDesignerMetaObjectInterface *superClass() const = 0;
    virtual const QExtDesignerMetaPropertyInterface *userProperty() const  = 0;
};

// To be obtained from core
class QEXT_DESIGNER_API QExtDesignerIntrospectionInterface {
public:
    QExtDesignerIntrospectionInterface();
    virtual ~QExtDesignerIntrospectionInterface();

    virtual const QExtDesignerMetaObjectInterface* metaObject(const QObject *object) const = 0;
};

QT_END_NAMESPACE

#endif // _QEXTDESIGNERABSTRACTMETAOBJECT_P_H
