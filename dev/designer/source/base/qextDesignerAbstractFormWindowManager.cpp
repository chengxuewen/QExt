...
/*!
    \class QExtDesignerAbstractFormWindowManager

    \brief The QExtDesignerAbstractFormWindowManager class allows you to
    manipulate the collection of form windows in Qt Designer, and
    control Qt Designer's form editing actions.

    \inmodule QtDesigner

    QExtDesignerAbstractFormWindowManager is not intended to be
    ...
    the QExtDesignerAbstractFormEditor::formWindowManager()
    function. For example:

    \snippet lib/tools_designer_src_lib_sdk_abstractformwindowmanager.cpp 0

    When implementing a custom widget plugin, a pointer to \QD's
    current QExtDesignerAbstractFormEditor object (\c formEditor in the
    ...
    In addition, QExtDesignerAbstractFormWindowManager contains a
    ...
    \sa QExtDesignerAbstractFormEditor, QExtDesignerAbstractFormWindow
*/

/*!
    \enum QExtDesignerAbstractFormWindowManager::Action
...
/*!
    \enum QExtDesignerAbstractFormWindowManager::ActionGroup
...
/*!
    ...
    manager.
*/
QExtDesignerAbstractFormWindowManager::QExtDesignerAbstractFormWindowManager(QObject *parent)
    : QObject(parent)
{
}
...
*/
QExtDesignerAbstractFormWindowManager::~QExtDesignerAbstractFormWindowManager() = default;
...
QAction *QExtDesignerAbstractFormWindowManager::actionCut() const
{
...
*/
#if QT_CONFIG(clipboard)
QAction *QExtDesignerAbstractFormWindowManager::actionCopy() const
{
...
*/
#if QT_CONFIG(clipboard)
QAction *QExtDesignerAbstractFormWindowManager::actionPaste() const
{
...
/*!
    ...
    Use action() instead.
*/
QAction *QExtDesignerAbstractFormWindowManager::actionDelete() const
{
...
/*!
    ...
    Use action() instead.
*/
QAction *QExtDesignerAbstractFormWindowManager::actionSelectAll() const
{
...
QAction *QExtDesignerAbstractFormWindowManager::actionLower() const
{
...
/*!
    ...
    Use action() instead.
*/
QAction *QExtDesignerAbstractFormWindowManager::actionRaise() const
{
...
/*!
    ...
    Use action() instead.
*/
QAction *QExtDesignerAbstractFormWindowManager::actionHorizontalLayout() const
{
...
/*!
    ...
    Use action() instead.
*/
QAction *QExtDesignerAbstractFormWindowManager::actionVerticalLayout() const
{
...
/*!
    ...
    Use action() instead.
*/
QAction *QExtDesignerAbstractFormWindowManager::actionSplitHorizontal() const
{
...
/*!
    ...
    Use action() instead.
*/
QAction *QExtDesignerAbstractFormWindowManager::actionSplitVertical() const
{
...
/*!
    ...
    Use action() instead.
*/
QAction *QExtDesignerAbstractFormWindowManager::actionGridLayout() const
{
...
QAction *QExtDesignerAbstractFormWindowManager::actionFormLayout() const
{
...
/*!
    ...
    Use action() instead.
*/
QAction *QExtDesignerAbstractFormWindowManager::actionBreakLayout() const
{
...
/*!
    ...
    Use action() instead.
*/
QAction *QExtDesignerAbstractFormWindowManager::actionAdjustSize() const
{
...
QAction *QExtDesignerAbstractFormWindowManager::actionSimplifyLayout() const
{
    return action(SimplifyLayoutAction);
}

/*!
  \fn virtual QExtDesignerAbstractFormWindow *QExtDesignerAbstractFormWindowManager::activeFormWindow() const
...
/*!
    \fn virtual QExtDesignerAbstractFormEditor *QExtDesignerAbstractFormWindowManager::core() const
    Returns a pointer to \QD's current QExtDesignerAbstractFormEditor
    object.
*/

/*!
   \fn virtual void QExtDesignerAbstractFormWindowManager::addFormWindow(QExtDesignerAbstractFormWindow *formWindow)
...
/*!
   \fn virtual void QExtDesignerAbstractFormWindowManager::removeFormWindow(QExtDesignerAbstractFormWindow *formWindow)
...
/*!
   \fn virtual void QExtDesignerAbstractFormWindowManager::setActiveFormWindow(QExtDesignerAbstractFormWindow *formWindow)
...
/*!
   \fn int QExtDesignerAbstractFormWindowManager::formWindowCount() const
   Returns the number of form windows maintained by \QD's form window
   manager.
*/

/*!
   \fn QExtDesignerAbstractFormWindow *QExtDesignerAbstractFormWindowManager::formWindow(int index) const
...
/*!
  \fn QExtDesignerAbstractFormWindow *QExtDesignerAbstractFormWindowManager::createFormWindow(QWidget *parent, Qt::WindowFlags flags)
...
/*!
  \fn QPixmap QExtDesignerAbstractFormWindowManager::createPreviewPixmap() const
...
/*!
    ...
    Use action() instead.
*/
QAction *QExtDesignerAbstractFormWindowManager::actionUndo() const
{
...
/*!
    ...
    Use action() instead.
*/
QAction *QExtDesignerAbstractFormWindowManager::actionRedo() const
{
    return action(RedoAction);
}

/*!
    \fn void QExtDesignerAbstractFormWindowManager::formWindowAdded(QExtDesignerAbstractFormWindow *formWindow)
...
/*!
    \fn void QExtDesignerAbstractFormWindowManager::formWindowSettingsChanged(QExtDesignerAbstractFormWindow *formWindow)
...
/*!
    \fn void QExtDesignerAbstractFormWindowManager::formWindowRemoved(QExtDesignerAbstractFormWindow *formWindow)
...
/*!
    \fn void QExtDesignerAbstractFormWindowManager::activeFormWindowChanged(QExtDesignerAbstractFormWindow *formWindow)
...
/*!
    \fn void QExtDesignerAbstractFormWindowManager::dragItems(const QList<QExtDesignerDnDItemInterface*> &item_list)

    \internal
*/

/*!
    \fn virtual QAction QExtDesignerAbstractFormWindowManager::action(Action action) const
...
/*!
    \fn virtual QActionGroup *QExtDesignerAbstractFormWindowManager::actionGroup(ActionGroup actionGroup) const
...
/*!
    \fn virtual void QExtDesignerAbstractFormWindowManager::showPreview()
...
/*!
    \fn virtual void QExtDesignerAbstractFormWindowManager::closeAllPreviews()
...
/*!
    \fn virtual void QExtDesignerAbstractFormWindowManager::showPluginDialog()
