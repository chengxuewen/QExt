...
class QEXT_DESIGNER_API QStackedWidgetPreviewEventFilter : public QObject
{
    Q_OBJECT
public:
...
class QEXT_DESIGNER_API QStackedWidgetEventFilter : public QStackedWidgetPreviewEventFilter
{
    Q_OBJECT
public:
...
class QEXT_DESIGNER_API QStackedWidgetPropertySheet : public QDesignerPropertySheet {
public:
