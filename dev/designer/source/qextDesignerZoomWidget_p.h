...
class QEXT_DESIGNER_API ZoomMenu : public QObject {
    Q_OBJECT
...
class QEXT_DESIGNER_API ZoomView : public QGraphicsView
{
...
class  QEXT_DESIGNER_API ZoomProxyWidget : public QGraphicsProxyWidget {
...
class QEXT_DESIGNER_API ZoomWidget : public ZoomView
{
