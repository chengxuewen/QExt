...
class QEXT_DESIGNER_API StyleSheetEditor : public QTextEdit
{
    Q_OBJECT
public:
...
// Edit a style sheet.
class QEXT_DESIGNER_API StyleSheetEditorDialog : public QDialog
{
    Q_OBJECT
public:
    enum Mode {
...
class QEXT_DESIGNER_API StyleSheetPropertyEditorDialog : public StyleSheetEditorDialog
{
    Q_OBJECT
public:
