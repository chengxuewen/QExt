...
class QEXT_DESIGNER_API QDesignerMemberSheet: public QObject, public QExtDesignerMemberSheetExtension
{
    Q_OBJECT
...
class QEXT_DESIGNER_API QDesignerMemberSheetFactory: public QExtensionFactory
{
    Q_OBJECT
