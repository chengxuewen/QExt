...
//
class QEXT_DESIGNER_API PropertyHelper {
...
class QEXT_DESIGNER_API PropertyListCommand : public QDesignerFormWindowCommand {
public:
...
class QEXT_DESIGNER_API SetPropertyCommand: public PropertyListCommand
{
...
class QEXT_DESIGNER_API ResetPropertyCommand: public PropertyListCommand
{
...
class QEXT_DESIGNER_API AddDynamicPropertyCommand: public QDesignerFormWindowCommand
{
...
class QEXT_DESIGNER_API RemoveDynamicPropertyCommand: public QDesignerFormWindowCommand
{
