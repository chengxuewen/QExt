...
class QEXT_DESIGNER_API QSimpleResource : public QAbstractFormBuilder
{
public:
...
// (Actions and widgets)
struct QEXT_DESIGNER_API FormBuilderClipboard {
...
class QEXT_DESIGNER_API QEditorFormBuilder : public QSimpleResource
{
public:
