...
#ifndef _QEXTDESIGNEREXTENSION_H
#define _QEXTDESIGNEREXTENSION_H
...
#define Q_DECLARE_EXTENSION_INTERFACE(IFace, IId) \
    ...
    { \
        ...
        return extension ? static_cast<IFace *>(extension->qt_metacast(IFace##_iid)) \
                         : static_cast<IFace *>(nullptr); \
    }

QT_END_NAMESPACE

#endif // _QEXTDESIGNEREXTENSION_H
