...
#ifndef _QEXTDESIGNEREXTENSIONFACTORY_H
#define _QEXTDESIGNEREXTENSIONFACTORY_H
...
class QEXT_DESIGNER_API QExtensionFactory : public QObject, public QAbstractExtensionFactory
{
    Q_OBJECT
...
#endif // _QEXTDESIGNEREXTENSIONFACTORY_H
