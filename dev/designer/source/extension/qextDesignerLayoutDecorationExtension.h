...
#ifndef _QEXTDESIGNERLAYOUTDECORATIONEXTENSION_H
#define _QEXTDESIGNERLAYOUTDECORATIONEXTENSION_H
...
class QExtDesignerLayoutDecorationExtension
{
public:
    enum InsertMode
    {
    ...
    virtual ~QExtDesignerLayoutDecorationExtension() {}
...
Q_DECLARE_EXTENSION_INTERFACE(QExtDesignerLayoutDecorationExtension, "org.qt-project.Qt.Designer.LayoutDecoration")

QT_END_NAMESPACE

#endif // _QEXTDESIGNERLAYOUTDECORATIONEXTENSION_H
