...
/*!
    ...
    using the QExtDesignerAbstractFormEditor::extensionManager()
    function. A pointer to \QD's current QExtDesignerAbstractFormEditor
    ...
    QExtDesignerContainerExtension , QExtDesignerMemberSheetExtension,
    QExtDesignerPropertySheetExtension and
    QExtDesignerTaskMenuExtension. \QD's behavior is the same whether the
    ...
    Designer, and how to to use the QExtDesignerTaskMenuExtension class
