...
class QEXT_DESIGNER_API LayoutInfo
{
public:
    enum Type
    {
...
QEXT_DESIGNER_API void getFormLayoutItemPosition(const QFormLayout *formLayout, int index, int *rowPtr, int *columnPtr = nullptr, int *rowspanPtr = nullptr, int *colspanPtr = nullptr);
QEXT_DESIGNER_API void formLayoutAddWidget(QFormLayout *formLayout, QWidget *w, const QRect &r, bool insert);
} // namespace qdesigner_internal
