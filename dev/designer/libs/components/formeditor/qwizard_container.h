...
class QWizardContainer: public QObject, public QExtDesignerContainerExtension
{
    Q_OBJECT
...
using QWizardContainerFactory = ExtensionFactory<QExtDesignerContainerExtension,  QWizard,  QWizardContainer>;
}  // namespace qdesigner_internal
