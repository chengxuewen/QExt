...
class QExtDesignerTaskMenuExtension;
...
public:
    ...
    QExtDesignerFormWindowCursorInterface *cursor() const override;
    ...
    QExtDesignerAbstractFormWindowTool *tool(int index) const override;
    void registerTool(QExtDesignerAbstractFormWindowTool *tool) override;
    ...
    bool dropDockWidget(QExtDesignerDnDItemInterface *item, const QPoint &global_mouse_pos);
    bool dropWidgets(const QList<QExtDesignerDnDItemInterface*> &item_list, QWidget *target,
