...
class QMainWindowContainer: public QObject, public QExtDesignerContainerExtension
{
    Q_OBJECT
...
using QMainWindowContainerFactory = ExtensionFactory<QExtDesignerContainerExtension, QMainWindow, QMainWindowContainer>;
}  // namespace qdesigner_internal
