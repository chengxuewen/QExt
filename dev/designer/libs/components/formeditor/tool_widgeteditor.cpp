...
WidgetEditorTool::WidgetEditorTool(FormWindow *formWindow)
    : QExtDesignerAbstractFormWindowTool(formWindow),
...
QExtDesignerAbstractFormEditor *WidgetEditorTool::core() const
{
    return m_formWindow->core();
}

QExtDesignerAbstractFormWindow *WidgetEditorTool::formWindow() const
{
    return m_formWindow;
}
...
void WidgetEditorTool::detectDockDrag(const QDesignerMimeData *mimeData)
{
    ...
    for (QExtDesignerDnDItemInterface *item : item_list) {
...
bool WidgetEditorTool::handleDragEnterMoveEvent(QWidget *widget, QWidget * /*managedWidget*/, QDragMoveEvent *e, bool isEnter)
{
    ...
    if (!m_formWindow->hasFeature(QExtDesignerAbstractFormWindow::EditFeature)) {
        e->ignore();
        return true;
    }
...
bool WidgetEditorTool::handleDropEvent(QWidget *widget, QWidget *, QDropEvent *e)
{
    ...
    if (!m_lastDropTarget ||
        !m_formWindow->hasFeature(QExtDesignerAbstractFormWindow::EditFeature)) {
        e->ignore();
        return true;
    }
