...
class QMdiAreaContainer: public QObject, public QExtDesignerContainerExtension
{
    Q_OBJECT
...
private:
    ...
    QExtDesignerPropertySheetExtension *currentWindowSheet() const;
...
using QMdiAreaContainerFactory = ExtensionFactory<QExtDesignerContainerExtension,  QMdiArea,  QMdiAreaContainer>;
