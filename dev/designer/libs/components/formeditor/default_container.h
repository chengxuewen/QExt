...
class QStackedWidgetContainer: public QObject, public QExtDesignerContainerExtension
{
    Q_OBJECT
...
// ------------ QTabWidgetContainer
class QTabWidgetContainer: public QObject, public QExtDesignerContainerExtension
{
    Q_OBJECT
    Q_INTERFACES(QExtDesignerContainerExtension)
public:
...
// ------------  QToolBoxContainer
class QToolBoxContainer: public QObject, public QExtDesignerContainerExtension
{
    Q_OBJECT
    Q_INTERFACES(QExtDesignerContainerExtension)
public:
...
class SingleChildContainer: public QExtDesignerContainerExtension
{
protected:
...
using QDesignerStackedWidgetContainerFactory = ExtensionFactory<QExtDesignerContainerExtension, QStackedWidget, QStackedWidgetContainer>;
using QDesignerTabWidgetContainerFactory = ExtensionFactory<QExtDesignerContainerExtension, QTabWidget, QTabWidgetContainer>;
using QDesignerToolBoxContainerFactory = ExtensionFactory<QExtDesignerContainerExtension, QToolBox, QToolBoxContainer>;
using QScrollAreaContainerFactory = ExtensionFactory<QExtDesignerContainerExtension, QScrollArea, QScrollAreaContainer>;
using QDockWidgetContainerFactory = ExtensionFactory<QExtDesignerContainerExtension,  QDockWidget, QDockWidgetContainer>;
}  // namespace qdesigner_internal
