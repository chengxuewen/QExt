...
NewDynamicPropertyDialog::NewDynamicPropertyDialog(QExtDesignerAbstractDialogGui *dialogGui,
                                                       QWidget *parent)   :
    QDialog(parent),
...
{
    m_dialogGui->message(this, QExtDesignerAbstractDialogGui::PropertyEditorMessage, QMessageBox::Information, tr("Set Property Name"), message);
}
