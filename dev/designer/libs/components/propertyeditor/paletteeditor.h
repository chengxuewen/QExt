...
public:
    ...
    static QPalette getPalette(QExtDesignerAbstractFormEditor *core,
...
private:
    PaletteEditor(QExtDesignerAbstractFormEditor *core, QWidget *parent);
    void buildPalette();
...
class BrushEditor : public QWidget
{
    Q_OBJECT
public:
    explicit BrushEditor(QExtDesignerAbstractFormEditor *core, QWidget *parent = nullptr);
...
public:
    explicit ColorDelegate(QExtDesignerAbstractFormEditor *core, QObject *parent = nullptr);
