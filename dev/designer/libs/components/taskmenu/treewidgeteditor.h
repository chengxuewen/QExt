...
class TreeWidgetEditor: public AbstractItemEditor
{
    Q_OBJECT
public:
    explicit TreeWidgetEditor(QExtDesignerAbstractFormWindow *form, QDialog *dialog);
...
class TreeWidgetEditorDialog : public QDialog
{
    Q_OBJECT
public:
    explicit TreeWidgetEditorDialog(QExtDesignerAbstractFormWindow *form, QWidget *parent);
