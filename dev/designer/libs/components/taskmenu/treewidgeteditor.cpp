...
TreeWidgetEditor::TreeWidgetEditor(QExtDesignerAbstractFormWindow *form, QDialog *dialog)
...
TreeWidgetContents TreeWidgetEditor::fillContentsFromTreeWidget(QTreeWidget *treeWidget)
{
    ...
    treeCont.m_headerItem.applyToListWidget(m_columnEditor->listWidget(), iconCache(), true); //TODO:cxw
...
TreeWidgetEditorDialog::TreeWidgetEditorDialog(QExtDesignerAbstractFormWindow *form, QWidget *parent) :
