...
TableWidgetEditor::TableWidgetEditor(QExtDesignerAbstractFormWindow *form, QDialog *dialog)
...
TableWidgetContents TableWidgetEditor::fillContentsFromTableWidget(QTableWidget *tableWidget)
{
    ...
    tblCont.m_verticalHeader.applyToListWidget(m_rowEditor->listWidget(), iconCache(), true, headerAlignment); //TODO:cxw
    ...
    tblCont.m_horizontalHeader.applyToListWidget(m_columnEditor->listWidget(), iconCache(), true, headerAlignment); //TODO:cxw
...
TableWidgetEditorDialog::TableWidgetEditorDialog(QExtDesignerAbstractFormWindow *form, QWidget *parent) :
