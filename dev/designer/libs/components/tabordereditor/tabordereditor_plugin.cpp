...
void TabOrderEditorPlugin::initialize(QExtDesignerAbstractFormEditor *core)
{
...
void TabOrderEditorPlugin::activeFormWindowChanged(QExtDesignerAbstractFormWindow *formWindow)
{
    m_action->setEnabled(formWindow != nullptr);
}

QExtDesignerAbstractFormEditor *TabOrderEditorPlugin::core() const
{
    return m_core;
}

void TabOrderEditorPlugin::addFormWindow(QExtDesignerAbstractFormWindow *formWindow)
{
...
void TabOrderEditorPlugin::removeFormWindow(QExtDesignerAbstractFormWindow *formWindow)
{
    Q_ASSERT(formWindow != nullptr);
