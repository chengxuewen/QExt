...
void SignalSlotEditorPlugin::initialize(QExtDesignerAbstractFormEditor *core)
{
    ...
    connect(core->formWindowManager(), &QExtDesignerAbstractFormWindowManager::formWindowAdded,
            this, &SignalSlotEditorPlugin::addFormWindow);

    connect(core->formWindowManager(), &QExtDesignerAbstractFormWindowManager::formWindowRemoved,
            this, &SignalSlotEditorPlugin::removeFormWindow);

    connect(core->formWindowManager(), &QExtDesignerAbstractFormWindowManager::activeFormWindowChanged,
            this, &SignalSlotEditorPlugin::activeFormWindowChanged);
}

QExtDesignerAbstractFormEditor *SignalSlotEditorPlugin::core() const
{
    return m_core;
}

void SignalSlotEditorPlugin::addFormWindow(QExtDesignerAbstractFormWindow *formWindow)
{
...
void SignalSlotEditorPlugin::removeFormWindow(QExtDesignerAbstractFormWindow *formWindow)
{
    Q_ASSERT(formWindow != nullptr);
...
void SignalSlotEditorPlugin::activeFormWindowChanged(QExtDesignerAbstractFormWindow *formWindow)
{
