...
static QString realClassName(QExtDesignerAbstractFormEditor *core, QWidget *widget)
{
...
static QString widgetLabel(QExtDesignerAbstractFormEditor *core, QWidget *widget)
{
...
ConnectDialog::ConnectDialog(QExtDesignerAbstractFormWindow *formWindow,
...
ConnectDialog::WidgetMode ConnectDialog::widgetMode(QWidget *w,  QExtDesignerAbstractFormWindow *formWindow)
{
