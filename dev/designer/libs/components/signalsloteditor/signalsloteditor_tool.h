...
class QT_SIGNALSLOTEDITOR_EXPORT SignalSlotEditorTool: public QExtDesignerAbstractFormWindowTool
{
    Q_OBJECT
public:
    explicit SignalSlotEditorTool(QExtDesignerAbstractFormWindow *formWindow, QObject *parent = nullptr);
