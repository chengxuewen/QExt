...
class SignalSlotEditorWindow : public QWidget
{
    Q_OBJECT
public:
    explicit SignalSlotEditorWindow(QExtDesignerAbstractFormEditor *core, QWidget *parent = nullptr);

public slots:
    void setActiveFormWindow(QExtDesignerAbstractFormWindow *form);
