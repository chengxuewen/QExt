...
/*!
    ...
    \sa QExtDesignerAbstractFormEditor, QExtDesignerAbstractObjectInspector,
        QExtDesignerAbstractPropertyEditor, QExtDesignerAbstractWidgetBox
*/
...
void QDesignerComponents::initializePlugins(QExtDesignerAbstractFormEditor *core)
{
    QExtDesignerIntegration::initializePlugins(core);
}

/*!
    Constructs a form editor interface with the given \a parent.*/
QExtDesignerAbstractFormEditor *QDesignerComponents::createFormEditor(QObject *parent)
{
    initInstances();
...
QObject *QDesignerComponents::createTaskMenu(QExtDesignerAbstractFormEditor *core, QObject *parent)
{
...
static inline QString widgetBoxFileName(int qtVersion, const QExtDesignerLanguageExtension *lang = nullptr)
{
    QString rc; {
...
QExtDesignerAbstractWidgetBox *QDesignerComponents::createWidgetBox(QExtDesignerAbstractFormEditor *core, QWidget *parent)
{
    qdesigner_internal::WidgetBox *widgetBox = new qdesigner_internal::WidgetBox(core, parent);

    const QExtDesignerLanguageExtension *lang = qt_extension<QExtDesignerLanguageExtension*>(core->extensionManager(), core);
...
QExtDesignerAbstractPropertyEditor *QDesignerComponents::createPropertyEditor(QExtDesignerAbstractFormEditor *core, QWidget *parent)
{
...
QExtDesignerAbstractObjectInspector *QDesignerComponents::createObjectInspector(QExtDesignerAbstractFormEditor *core, QWidget *parent)
{
...
QExtDesignerAbstractActionEditor *QDesignerComponents::createActionEditor(QExtDesignerAbstractFormEditor *core, QWidget *parent)
{
...
QWidget *QDesignerComponents::createResourceEditor(QExtDesignerAbstractFormEditor *core, QWidget *parent)
{
    ...
    const QExtDesignerAbstractIntegration *integration = core->integration();
    if (integration && !integration->hasFeature(QExtDesignerAbstractIntegration::ResourceEditorFeature))
...
QWidget *QDesignerComponents::createSignalSlotEditor(QExtDesignerAbstractFormEditor *core, QWidget *parent)
{
