...
PaletteEditor::PaletteEditor(QExtDesignerAbstractFormEditor *core, QWidget *parent) :
    QDialog(parent),
...
QPalette PaletteEditor::getPalette(QExtDesignerAbstractFormEditor *core, QWidget* parent, const QPalette &init,
...
BrushEditor::BrushEditor(QExtDesignerAbstractFormEditor *core, QWidget *parent) :
    QWidget(parent),
...
//////////////////////////
ColorDelegate::ColorDelegate(QExtDesignerAbstractFormEditor *core, QObject *parent) :
