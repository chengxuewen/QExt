...
class QT_PROPERTYEDITOR_EXPORT PropertyEditor: public QDesignerPropertyEditor
{
    Q_OBJECT
public:
    explicit PropertyEditor(QExtDesignerAbstractFormEditor *core, QWidget *parent = nullptr, Qt::WindowFlags flags = {});
...
private:
    ...
    QExtDesignerMetaDataBaseItemInterface *metaDataBaseItem() const;
    ...
    QExtDesignerPropertySheetExtension *m_propertySheet = nullptr;
