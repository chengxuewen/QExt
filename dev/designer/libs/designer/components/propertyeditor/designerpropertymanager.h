...
class ResetDecorator : public QObject
{
    Q_OBJECT
public:
    explicit ResetDecorator(const QExtDesignerAbstractFormEditor *core, QObject *parent = nullptr);
    ~ResetDecorator();
...
private:
    ...
    int m_spacing;
    const QExtDesignerAbstractFormEditor *m_core;
};
...
public:
    ...
    explicit DesignerPropertyManager(QExtDesignerAbstractFormEditor *core, QObject *parent = nullptr);
...
class DesignerEditorFactory : public QtVariantEditorFactory
{
    Q_OBJECT
public:
    explicit DesignerEditorFactory(QExtDesignerAbstractFormEditor *core, QObject *parent = nullptr);
