...
TabOrderEditorTool::TabOrderEditorTool(QExtDesignerAbstractFormWindow *formWindow, QObject *parent)
...
QExtDesignerAbstractFormEditor *TabOrderEditorTool::core() const
{
    return m_formWindow->core();
}

QExtDesignerAbstractFormWindow *TabOrderEditorTool::formWindow() const
{
    return m_formWindow;
}
...
{
    disconnect(formWindow(), &QExtDesignerAbstractFormWindow::changed,
                m_editor.data(), &TabOrderEditor::updateBackground);
}
