...
class QT_TABORDEREDITOR_EXPORT TabOrderEditorTool: public QExtDesignerAbstractFormWindowTool
{
    Q_OBJECT
public:
    explicit TabOrderEditorTool(QExtDesignerAbstractFormWindow *formWindow, QObject *parent = nullptr);
