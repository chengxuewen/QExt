...
class QT_TABORDEREDITOR_EXPORT TabOrderEditorPlugin: public QObject, public QExtDesignerFormEditorPluginInterface
{
    Q_OBJECT
    Q_PLUGIN_METADATA(IID "org.qt-project.Qt.QExtDesignerFormEditorPluginInterface" FILE "tabordereditor.json")
...
private:
    ...
    QHash<QExtDesignerAbstractFormWindow*, TabOrderEditorTool*> m_tools;
