...
class ConnectDialog : public QDialog
{
    Q_OBJECT
public:
    ConnectDialog(QExtDesignerAbstractFormWindow *formWindow, QWidget *sender, QWidget *receiver, QWidget *parent = nullptr);
...
private:
    ...
    static WidgetMode widgetMode(QWidget *w,  QExtDesignerAbstractFormWindow *formWindow);
