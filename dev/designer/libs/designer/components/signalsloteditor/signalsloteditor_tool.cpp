...
SignalSlotEditorTool::SignalSlotEditorTool(QExtDesignerAbstractFormWindow *formWindow, QObject *parent)
...
QExtDesignerAbstractFormEditor *SignalSlotEditorTool::core() const
{
    return m_formWindow->core();
}

QExtDesignerAbstractFormWindow *SignalSlotEditorTool::formWindow() const
{
    return m_formWindow;
}
...
QWidget *SignalSlotEditorTool::editor() const
{
    if (!m_editor) {
        ...
        m_editor = new SignalSlotEditor(formWindow(), nullptr);
