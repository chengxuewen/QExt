...
////////////////// Item editor ///////////////
AbstractItemEditor::AbstractItemEditor(QExtDesignerAbstractFormWindow *form, QWidget *parent)
    : QWidget(parent),
...
void AbstractItemEditor::setupObject(QWidget *object)
{
    ...
    QExtDesignerAbstractFormWindow *formWindow = QExtDesignerAbstractFormWindow::findFormWindow(object);
...
////////////////// List editor ///////////////
ItemListEditor::ItemListEditor(QExtDesignerAbstractFormWindow *form, QWidget *parent)
