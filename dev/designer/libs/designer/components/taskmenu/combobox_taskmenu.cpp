...
{
    m_formWindow = QExtDesignerAbstractFormWindow::findFormWindow(m_comboBox);
...
ComboBoxTaskMenuFactory::ComboBoxTaskMenuFactory(const QString &iid, QExtensionManager *extensionManager) :
    ExtensionFactory<QExtDesignerTaskMenuExtension, QComboBox, ComboBoxTaskMenu>(iid, extensionManager)
{
}
