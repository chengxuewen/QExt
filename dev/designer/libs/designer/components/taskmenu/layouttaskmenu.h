...
class LayoutWidgetTaskMenu : public QObject, public QExtDesignerTaskMenuExtension
{
    Q_OBJECT
...
class SpacerTaskMenu : public QObject, public QExtDesignerTaskMenuExtension
{
    Q_OBJECT
    Q_INTERFACES(QExtDesignerTaskMenuExtension)
public:
...
using LayoutWidgetTaskMenuFactory = qdesigner_internal::ExtensionFactory<QExtDesignerTaskMenuExtension, QLayoutWidget, LayoutWidgetTaskMenu>;
using SpacerTaskMenuFactory = qdesigner_internal::ExtensionFactory<QExtDesignerTaskMenuExtension, Spacer, SpacerTaskMenu>;
