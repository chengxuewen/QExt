...
class MenuTaskMenu : public QObject, public QExtDesignerTaskMenuExtension
{
    Q_OBJECT
...
class MenuBarTaskMenu : public QObject, public QExtDesignerTaskMenuExtension
{
    Q_OBJECT
    Q_INTERFACES(QExtDesignerTaskMenuExtension)
public:
...
using MenuTaskMenuFactory = ExtensionFactory<QExtDesignerTaskMenuExtension, QDesignerMenu, MenuTaskMenu>;
using MenuBarTaskMenuFactory = ExtensionFactory<QExtDesignerTaskMenuExtension, QDesignerMenuBar, MenuBarTaskMenu>;
