...
{
    if (const QExtDesignerContainerExtension *ce = containerExtension())
        return ce->count();
    return 0;
}
...
{
    const QExtDesignerContainerExtension *ce = containerExtension();
...
QExtDesignerAbstractFormWindow *ContainerWidgetTaskMenu::formWindow() const
{
    return QExtDesignerAbstractFormWindow::findFormWindow(m_containerWidget);
}

QExtDesignerContainerExtension *ContainerWidgetTaskMenu::containerExtension() const
{
...
ContainerWidgetTaskMenuFactory::ContainerWidgetTaskMenuFactory(QExtDesignerAbstractFormEditor *core, QExtensionManager *extensionManager) :
...
QObject *ContainerWidgetTaskMenuFactory::createExtension(QObject *object, const QString &iid, QObject *parent) const
{
    ...
    if (qt_extension<QExtDesignerContainerExtension*>(extensionManager(), object) == nullptr)
        return nullptr;
