...
class ToolBarTaskMenu : public QObject, public QExtDesignerTaskMenuExtension
{
    Q_OBJECT
...
class StatusBarTaskMenu : public QObject, public QExtDesignerTaskMenuExtension
{
    Q_OBJECT
    Q_INTERFACES(QExtDesignerTaskMenuExtension)
public:
...
using ToolBarTaskMenuFactory = ExtensionFactory<QExtDesignerTaskMenuExtension, QToolBar, ToolBarTaskMenu>;
using StatusBarTaskMenuFactory = ExtensionFactory<QExtDesignerTaskMenuExtension, QStatusBar, StatusBarTaskMenu>;
