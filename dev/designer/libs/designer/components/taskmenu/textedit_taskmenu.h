...
using TextEditTaskMenuFactory = ExtensionFactory<QExtDesignerTaskMenuExtension, QTextEdit, TextEditTaskMenu>;
using PlainTextEditTaskMenuFactory = ExtensionFactory<QExtDesignerTaskMenuExtension, QPlainTextEdit, TextEditTaskMenu>;
}  // namespace qdesigner_internal
