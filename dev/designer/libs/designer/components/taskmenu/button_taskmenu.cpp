...
protected:
    ButtonGroupCommand(const QString &description, QExtDesignerAbstractFormWindow *formWindow);
...
public:
    ...
    static ButtonGroupList managedButtonGroups(const QExtDesignerAbstractFormWindow *formWindow);
...
ButtonGroupCommand::ButtonGroupCommand(const QString &description, QExtDesignerAbstractFormWindow *formWindow) :
...
ButtonGroupList ButtonGroupCommand::managedButtonGroups(const QExtDesignerAbstractFormWindow *formWindow)
{
    const QExtDesignerAbstractMetaDataBase *mdb = formWindow->core()->metaDataBase();
    ButtonGroupList bl;
...
public:
    CreateButtonGroupCommand(QExtDesignerAbstractFormWindow *formWindow);
...
CreateButtonGroupCommand::CreateButtonGroupCommand(QExtDesignerAbstractFormWindow *formWindow) :
...
public:
    BreakButtonGroupCommand(QExtDesignerAbstractFormWindow *formWindow);
...
BreakButtonGroupCommand::BreakButtonGroupCommand(QExtDesignerAbstractFormWindow *formWindow) :
...
public:
    AddButtonsToGroupCommand(QExtDesignerAbstractFormWindow *formWindow);
...
AddButtonsToGroupCommand::AddButtonsToGroupCommand(QExtDesignerAbstractFormWindow *formWindow) :
...
public:
    RemoveButtonsFromGroupCommand(QExtDesignerAbstractFormWindow *formWindow);
    bool init(const ButtonList &bl);
...
RemoveButtonsFromGroupCommand::RemoveButtonsFromGroupCommand(QExtDesignerAbstractFormWindow *formWindow) :
...
void ButtonGroupMenu::initialize(QExtDesignerAbstractFormWindow *formWindow, QButtonGroup *buttonGroup, QAbstractButton *currentButton)
{
    m_buttonGroup = buttonGroup;
...
{
    m_menu.initialize(QExtDesignerAbstractFormWindow::findFormWindow(m_buttonGroup), m_buttonGroup);
...
bool ButtonTaskMenu::refreshAssignMenu(const QExtDesignerAbstractFormWindow *fw, int buttonCount, SelectionType st, QButtonGroup *currentGroup)
{
    // clear
...
static ButtonList buttonList(const QExtDesignerFormWindowCursorInterface *cursor)
{
    ButtonList rc;
...
static QUndoCommand *createRemoveButtonsCommand(QExtDesignerAbstractFormWindow *fw, const ButtonList &bl)
{
...
ButtonTaskMenu::SelectionType ButtonTaskMenu::selectionType(const QExtDesignerFormWindowCursorInterface *cursor, QButtonGroup **ptrToGroup) const
{
    const int selectionCount = cursor->selectedWidgetCount();
    if (!selectionCount)
