...
class TableWidgetEditor: public AbstractItemEditor
{
    Q_OBJECT
public:
    explicit TableWidgetEditor(QExtDesignerAbstractFormWindow *form, QDialog *dialog);
...
class TableWidgetEditorDialog : public QDialog
{
    Q_OBJECT
public:
    explicit TableWidgetEditorDialog(QExtDesignerAbstractFormWindow *form, QWidget *parent);
