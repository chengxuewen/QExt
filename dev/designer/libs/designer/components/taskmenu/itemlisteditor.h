...
public:
    explicit AbstractItemEditor(QExtDesignerAbstractFormWindow *form, QWidget *parent);
    ~AbstractItemEditor();
...
public:
    explicit ItemListEditor(QExtDesignerAbstractFormWindow *form, QWidget *parent);
