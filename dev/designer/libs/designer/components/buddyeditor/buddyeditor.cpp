...
static bool canBeBuddy(QWidget *w, QExtDesignerAbstractFormWindow *form)
{
    ...
    if (QExtDesignerPropertySheetExtension *sheet = qt_extension<QExtDesignerPropertySheetExtension*>(ext, w)) {
...
static QString buddy(QLabel *label, QExtDesignerAbstractFormEditor *core)
{
    QExtDesignerPropertySheetExtension *sheet = qt_extension<QExtDesignerPropertySheetExtension*>(core->extensionManager(), label);
    if (sheet == nullptr)
        return QString();
...
BuddyEditor::BuddyEditor(QExtDesignerAbstractFormWindow *form, QWidget *parent) :
...
QExtDesignerAbstractFormWindow *BuddyEditor::formWindow() const
{
    return m_formWindow;
}
...
static QUndoCommand *createBuddyCommand(QExtDesignerAbstractFormWindow *fw, QLabel *label, QWidget *buddy)
{
