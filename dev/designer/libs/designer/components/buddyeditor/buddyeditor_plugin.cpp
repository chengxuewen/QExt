...
void BuddyEditorPlugin::initialize(QExtDesignerAbstractFormEditor *core)
{
...
QExtDesignerAbstractFormEditor *BuddyEditorPlugin::core() const
{
    return m_core;
}

void BuddyEditorPlugin::addFormWindow(QExtDesignerAbstractFormWindow *formWindow)
{
...
void BuddyEditorPlugin::removeFormWindow(QExtDesignerAbstractFormWindow *formWindow)
{
    Q_ASSERT(formWindow != nullptr);
...
void BuddyEditorPlugin::activeFormWindowChanged(QExtDesignerAbstractFormWindow *formWindow)
{
