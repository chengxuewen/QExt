...
class QT_BUDDYEDITOR_EXPORT BuddyEditorPlugin: public QObject, public QExtDesignerFormEditorPluginInterface
{
    Q_OBJECT
    Q_PLUGIN_METADATA(IID "org.qt-project.Qt.QExtDesignerFormEditorPluginInterface" FILE "buddyeditor.json")
...
private:
    ...
    QHash<QExtDesignerAbstractFormWindow*, BuddyEditorTool*> m_tools;
