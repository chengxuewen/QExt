...
class QT_BUDDYEDITOR_EXPORT BuddyEditorTool: public QExtDesignerAbstractFormWindowTool
{
    Q_OBJECT
public:
    explicit BuddyEditorTool(QExtDesignerAbstractFormWindow *formWindow, QObject *parent = nullptr);
