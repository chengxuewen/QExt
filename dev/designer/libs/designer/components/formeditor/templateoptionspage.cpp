...
TemplateOptionsWidget::TemplateOptionsWidget(QExtDesignerAbstractFormEditor *core, QWidget *parent) :
    QWidget(parent),
    m_core(core),
...
QString TemplateOptionsWidget::chooseTemplatePath(QExtDesignerAbstractFormEditor *core, QWidget *parent)
{
...
// ----------------- TemplateOptionsPage
TemplateOptionsPage::TemplateOptionsPage(QExtDesignerAbstractFormEditor *core) :
    m_core(core)
{
}
