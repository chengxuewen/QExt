...
class EmbeddedOptionsControl : public QWidget {
    ...
    Q_OBJECT
public:
    explicit EmbeddedOptionsControl(QExtDesignerAbstractFormEditor *core, QWidget *parent = nullptr);
...
// EmbeddedOptionsPage
class EmbeddedOptionsPage : public QExtDesignerOptionsPageInterface
{
    Q_DISABLE_COPY_MOVE(EmbeddedOptionsPage)
public:
    explicit EmbeddedOptionsPage(QExtDesignerAbstractFormEditor *core);
