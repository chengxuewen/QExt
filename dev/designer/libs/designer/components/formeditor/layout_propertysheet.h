...
public:
    ...
    static void stretchAttributesToDom(QExtDesignerAbstractFormEditor *core, QLayout *lt, DomLayout *domLayout);
    static void markChangedStretchProperties(QExtDesignerAbstractFormEditor *core, QLayout *lt, const DomLayout *domLayout);
