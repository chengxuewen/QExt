...
static inline Layout *managedLayoutOf(const QExtDesignerAbstractFormEditor *core,
                                      QWidget *w,
...
QExtDesignerAbstractFormEditor *WidgetHandle::core() const
{
    if (m_formWindow)
...
{
    QExtDesignerAbstractFormWindowManager *m = m_formWindow->core()->formWindowManager();
...
{
    QExtDesignerLayoutDecorationExtension *deco = qt_extension<QExtDesignerLayoutDecorationExtension*>(core()->extensionManager(), m_widget->parentWidget());
    if (!deco)
       return;
...
WidgetSelection::WidgetState WidgetSelection::widgetState(const QExtDesignerAbstractFormEditor *core, QWidget *w)
{
    bool isManaged;
...
QExtDesignerAbstractFormEditor *WidgetSelection::core() const
{
    if (m_formWindow)
        return m_formWindow->core();
