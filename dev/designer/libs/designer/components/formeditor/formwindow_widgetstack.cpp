...
QExtDesignerAbstractFormWindowTool *FormWindowWidgetStack::currentTool() const
{
...
void FormWindowWidgetStack::setCurrentTool(int index)
{
    ...
    QExtDesignerAbstractFormWindowTool *tool = m_tools.at(index);
    tool->activated();
...
{
    QExtDesignerAbstractFormWindowTool *tool = nullptr;
    ...
    for (QExtDesignerAbstractFormWindowTool *t : qAsConst(m_tools)) {
        if (action == t->action()) {
            tool = t;
            break;
        }
...
int FormWindowWidgetStack::indexOf(QExtDesignerAbstractFormWindowTool *tool) const
{
    return m_tools.indexOf(tool);
}

void FormWindowWidgetStack::setCurrentTool(QExtDesignerAbstractFormWindowTool *tool)
{
...
void FormWindowWidgetStack::addTool(QExtDesignerAbstractFormWindowTool *tool)
{
...
QExtDesignerAbstractFormWindowTool *FormWindowWidgetStack::tool(int index) const
{
