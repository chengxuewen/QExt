...
DeviceProfileDialog::DeviceProfileDialog(QExtDesignerAbstractDialogGui *dlgGui, QWidget *parent) :
    QDialog(parent),
...
{
    m_dlgGui->message(this, QExtDesignerAbstractDialogGui::OtherMessage, QMessageBox::Critical, title, msg);
}
}
