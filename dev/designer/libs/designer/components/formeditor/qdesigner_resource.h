...
protected:
    ...
    DomWidget *saveWidget(QWidget *widget, QExtDesignerContainerExtension *container, DomWidget *ui_parentWidget);
...
private:
    ...
    QHash<QExtDesignerWidgetDataBaseItemInterface*, bool> m_usedCustomWidgets;
    bool m_copyWidget;
    QWidget *m_selected;
