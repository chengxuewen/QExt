...
static bool ask(QWidget *parent,
                QExtDesignerAbstractDialogGui *dlgui,
                const QString &title,
                const QString &what)
{
    return dlgui->message(parent, QExtDesignerAbstractDialogGui::OtherMessage,
...
public:
    EmbeddedOptionsControlPrivate(QExtDesignerAbstractFormEditor *core);
...
EmbeddedOptionsControlPrivate::EmbeddedOptionsControlPrivate(QExtDesignerAbstractFormEditor *core) :
    m_core(core),
...
EmbeddedOptionsControl::EmbeddedOptionsControl(QExtDesignerAbstractFormEditor *core, QWidget *parent) :
    QWidget(parent),
...
// EmbeddedOptionsPage:
EmbeddedOptionsPage::EmbeddedOptionsPage(QExtDesignerAbstractFormEditor *core) :
    m_core(core)
{
}
