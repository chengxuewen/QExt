...
public:
    explicit TemplateOptionsWidget(QExtDesignerAbstractFormEditor *core,
    ...
    static QString chooseTemplatePath(QExtDesignerAbstractFormEditor *core, QWidget *parent);
...
class TemplateOptionsPage : public QExtDesignerOptionsPageInterface
{
     Q_DISABLE_COPY_MOVE(TemplateOptionsPage)
public:
    explicit TemplateOptionsPage(QExtDesignerAbstractFormEditor *core);
