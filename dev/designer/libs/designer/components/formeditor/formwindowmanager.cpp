...
FormWindowManager::FormWindowManager(QExtDesignerAbstractFormEditor *core, QObject *parent) :
...
QExtDesignerAbstractFormEditor *FormWindowManager::core() const
{
    return m_core;
}

QExtDesignerAbstractFormWindow *FormWindowManager::activeFormWindow() const
{
...
QExtDesignerAbstractFormWindow *FormWindowManager::formWindow(int index) const
{
...
void FormWindowManager::addFormWindow(QExtDesignerAbstractFormWindow *w)
{
    ...
    connect(formWindow->commandHistory(), &QUndoStack::indexChanged,
            this, &FormWindowManager::slotUpdateActions);
    connect(formWindow, &QExtDesignerAbstractFormWindow::toolChanged,
            this, &FormWindowManager::slotUpdateActions);

    if (ActionEditor *ae = qobject_cast<ActionEditor *>(m_core->actionEditor())) {
        connect(w, &QExtDesignerAbstractFormWindow::mainContainerChanged,
...
void FormWindowManager::removeFormWindow(QExtDesignerAbstractFormWindow *w)
{
    FormWindow *formWindow = qobject_cast<FormWindow*>(w);
...
void FormWindowManager::setActiveFormWindow(QExtDesignerAbstractFormWindow *w)
{
    FormWindow *formWindow = qobject_cast<FormWindow*>(w);
...
{
    QExtDesignerAbstractFormWindow *fw = activeFormWindow();
    if (!fw)
        return;
    ...
    if (!m_previewManager->showPreview(fw, style, deviceProfileIndex, &errorMessage)) {
        ...
        core()->dialogGui()->message(fw, QExtDesignerAbstractDialogGui::FormEditorMessage, QMessageBox::Warning,
                                     title, errorMessage);
    }
}
...
QWidgetList FormWindowManager::layoutsToBeBroken(QWidget *w) const
{
    ...
    const QExtDesignerWidgetDataBaseItemInterface *item = db->item(db->indexOfObject(widget));
    if (!item) {
        if (debugFWM)
...
static inline bool hasManagedLayoutItems(const QExtDesignerAbstractFormEditor *core, QWidget *w)
{
...
QExtDesignerAbstractFormWindow *FormWindowManager::createFormWindow(QWidget *parentWidget, Qt::WindowFlags flags)
{
...
{
    const QExtDesignerAbstractFormWindow *fw = activeFormWindow();
    if (!fw)
        return QPixmap();
    QString errorMessage;
...
void FormWindowManager::dragItems(const QList<QExtDesignerDnDItemInterface*> &item_list)
{
...
void FormWindowManager::slotActionShowFormWindowSettingsDialog()
{
    ...
    if (QExtDesignerLanguageExtension *lang = qt_extension<QExtDesignerLanguageExtension*>(m_core->extensionManager(), m_core))
...
QAction *FormWindowManager::action(Action action) const
{
    switch (action) {
#if QT_CONFIG(clipboard)
    case QExtDesignerAbstractFormWindowManager::CutAction:
        return m_actionCut;
    case QExtDesignerAbstractFormWindowManager::CopyAction:
        return m_actionCopy;
    case QExtDesignerAbstractFormWindowManager::PasteAction:
        return m_actionPaste;
#endif
    case QExtDesignerAbstractFormWindowManager::DeleteAction:
        return m_actionDelete;
    case QExtDesignerAbstractFormWindowManager::SelectAllAction:
        return m_actionSelectAll;
    case QExtDesignerAbstractFormWindowManager::LowerAction:
        return m_actionLower;
    case QExtDesignerAbstractFormWindowManager::RaiseAction:
        return m_actionRaise;
    case QExtDesignerAbstractFormWindowManager::UndoAction:
        return m_actionUndo;
    case QExtDesignerAbstractFormWindowManager::RedoAction:
        return m_actionRedo;
    case QExtDesignerAbstractFormWindowManager::HorizontalLayoutAction:
        return m_actionHorizontalLayout;
    case QExtDesignerAbstractFormWindowManager::VerticalLayoutAction:
        return m_actionVerticalLayout;
    case QExtDesignerAbstractFormWindowManager::SplitHorizontalAction:
        return m_actionSplitHorizontal;
    case QExtDesignerAbstractFormWindowManager::SplitVerticalAction:
        return m_actionSplitVertical;
    case QExtDesignerAbstractFormWindowManager::GridLayoutAction:
        return m_actionGridLayout;
    case QExtDesignerAbstractFormWindowManager::FormLayoutAction:
        return m_actionFormLayout;
    case QExtDesignerAbstractFormWindowManager::BreakLayoutAction:
        return m_actionBreakLayout;
    case QExtDesignerAbstractFormWindowManager::AdjustSizeAction:
        return m_actionAdjustSize;
    case QExtDesignerAbstractFormWindowManager::SimplifyLayoutAction:
        return m_actionSimplifyLayout;
    case QExtDesignerAbstractFormWindowManager::DefaultPreviewAction:
        return m_actionDefaultPreview;
    case QExtDesignerAbstractFormWindowManager::FormWindowSettingsDialogAction:
...
{
    switch (actionGroup) {
    case QExtDesignerAbstractFormWindowManager::StyledPreviewActionGroup:
