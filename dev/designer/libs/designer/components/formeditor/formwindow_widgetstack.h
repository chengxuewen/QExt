...
public:
    ...
    int count() const;
    QExtDesignerAbstractFormWindowTool *tool(int index) const;
    QExtDesignerAbstractFormWindowTool *currentTool() const;
    int currentIndex() const;
    int indexOf(QExtDesignerAbstractFormWindowTool *tool) const;
...
public slots:
    void addTool(QExtDesignerAbstractFormWindowTool *tool);
    void setCurrentTool(QExtDesignerAbstractFormWindowTool *tool);
...
private:
    QList<QExtDesignerAbstractFormWindowTool*> m_tools;
