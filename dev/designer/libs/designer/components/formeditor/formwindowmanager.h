    ...
    : public QDesignerFormWindowManager
{
    Q_OBJECT
public:
    explicit FormWindowManager(QExtDesignerAbstractFormEditor *core, QObject *parent = nullptr);
    ...
    QExtDesignerAbstractFormWindow *activeFormWindow() const override;

    int formWindowCount() const override;
    QExtDesignerAbstractFormWindow *formWindow(int index) const override;

    QExtDesignerAbstractFormWindow *createFormWindow(QWidget *parentWidget = nullptr, Qt::WindowFlags flags = {}) override;

    QPixmap createPreviewPixmap() const override;

    bool eventFilter(QObject *o, QEvent *e) override;

    void dragItems(const QList<QExtDesignerDnDItemInterface*> &item_list) override;
...
public slots:
    void addFormWindow(QExtDesignerAbstractFormWindow *formWindow) override;
    void removeFormWindow(QExtDesignerAbstractFormWindow *formWindow) override;
    void setActiveFormWindow(QExtDesignerAbstractFormWindow *formWindow) override;
