...
WidgetBoxTreeWidget::WidgetBoxTreeWidget(QExtDesignerAbstractFormEditor *core, QWidget *parent) :
    QTreeWidget(parent),
    m_core(core),
    m_iconMode(false),
...
void WidgetBoxTreeWidget::dropWidgets(const QList<QExtDesignerDnDItemInterface*> &item_list)
{
