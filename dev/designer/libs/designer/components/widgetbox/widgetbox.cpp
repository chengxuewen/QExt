...
WidgetBox::WidgetBox(QExtDesignerAbstractFormEditor *core, QWidget *parent, Qt::WindowFlags flags)
...
QExtDesignerAbstractFormEditor *WidgetBox::core() const
{
    return m_core;
}
...
QExtDesignerAbstractWidgetBox::Category WidgetBox::category(int cat_idx) const
{
...
QExtDesignerAbstractWidgetBox::Widget WidgetBox::widget(int cat_idx, int wgt_idx) const
{
...
void WidgetBox::dropWidgets(const QList<QExtDesignerDnDItemInterface*> &item_list, const QPoint&)
{
