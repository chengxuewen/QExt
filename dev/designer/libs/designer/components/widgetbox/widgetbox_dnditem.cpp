...
static inline DeviceProfile currentDeviceProfile(const QExtDesignerAbstractFormEditor *core)
{
    if (QExtDesignerAbstractFormWindow *cfw = core->formWindowManager()->activeFormWindow())
...
{
public:
    WidgetBoxResource(QExtDesignerAbstractFormEditor *core);
...
WidgetBoxResource::WidgetBoxResource(QExtDesignerAbstractFormEditor *core) :
...
static QWidget *decorationFromDomWidget(DomUI *dom_ui, QExtDesignerAbstractFormEditor *core)
{
...
WidgetBoxDnDItem::WidgetBoxDnDItem(QExtDesignerAbstractFormEditor *core,
                                   DomUI *dom_ui,
