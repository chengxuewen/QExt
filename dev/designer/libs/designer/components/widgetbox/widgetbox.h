...
class QT_WIDGETBOX_EXPORT WidgetBox : public QDesignerWidgetBox
{
    Q_OBJECT
public:
    explicit WidgetBox(QExtDesignerAbstractFormEditor *core, QWidget *parent = nullptr,
    ...
    void dropWidgets(const QList<QExtDesignerDnDItemInterface*> &item_list, const QPoint &global_mouse_pos) override;
