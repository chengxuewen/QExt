...
public:
    using Widget = QExtDesignerAbstractWidgetBox::Widget;
    using Category = QExtDesignerAbstractWidgetBox::Category;
    using CategoryList = QExtDesignerAbstractWidgetBox::CategoryList;

    explicit WidgetBoxTreeWidget(QExtDesignerAbstractFormEditor *core, QWidget *parent = nullptr);
    ~WidgetBoxTreeWidget();
